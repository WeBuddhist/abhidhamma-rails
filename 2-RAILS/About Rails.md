...
│ ├── <term>_(<disambiguating-phrase>).md # e.g. kusala_(wholesome).md
│ └──...
...
---
node_id: 1-0a-0
commentary_id: dhammasangani-atthakatha
language: Pali
source_file: 1-SOURCES/Commentaries/pi-dhammasangani-atthakatha.md
...
(1-SOURCES/Commentaries/pi-dhammasangani-atthakatha.md#^…)
```
...
### dhammasangani-atthakatha — Aṭṭhasālinī (Pāli)
...
### dhammasangani-mulatiika — Mūlaṭīkā on the Aṭṭhasālinī (Pāli)
...
One page per attested sense ID within this text. Sense IDs are Wikipedia-style: `term (disambiguating phrase)`, e.g. `kusala (wholesome)`. The filename converts the parenthetical to hyphenated lowercase with an underscore: `kusala_(wholesome).md`.

```yaml
---
sense_id: kusala (wholesome)
term: kusala
language: Pali
...
| ------ | ----------- | -------- | ---------------------------------------------------------------- |
| 1-1 | defined | complete | (1-SOURCES/Commentaries/pi-dhammasangani-atthakatha.md#^1-1) |
| 1-0a-1 | elaborated | partial | (1-SOURCES/Commentaries/pi-dhammasangani-atthakatha.md#^1-0a-1) |

## Related Senses

- [[kusala (skilful)]] — a closely related sense distinguished by …
- [[akusala (unwholesome)]] — the opposite term
```
...
**Source lemma:** kusala (Pāli, PTS)
**POS:** adjective → adjective / noun
**Wikidata QID:** Q…
**Wiktionary (source):** https://en.wiktionary.org/wiki/kusala
...
**Local-Wiki link:** [[Local-Wiki/kusala_(wholesome).md]]
...
```markdown
## Source Text
![[1-SOURCES/Text/pi-dhammasangani.md#^6-33]]
![[1-SOURCES/Text/pi-dhammasangani.md#^6-34]]
```
