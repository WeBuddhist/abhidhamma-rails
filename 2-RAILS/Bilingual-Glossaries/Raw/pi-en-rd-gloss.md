...
\glb    results   States   resultant_quality_(States)   neither_(result_nor_resultant_quality_States)
...
\glb    grasped_and_favourable_to_grasping      States   not_grasped_but_favourable      (States) neither_(grasped_nor_favourable) (States)
...
\glb    vitiated_and_vicious     States   not_vitiated_but_vicious        (States) neither_(vitiated_nor_vicious) (States)
...
\glb    with_applied_and_sustained      States   with_sustained_only       (States) neither_(applied_nor_sustained) (States)
...
\glb    by_vision   to_be_put_away     States   by_culture   (to_be_put_away)   (States) by_neither    (by_vision) (nor) (by_culture) (to_be_put_away)   (States)
...
\glb    by_vision   moral_roots_to_be_put_away    States   by_culture   (moral_roots_to_be_put_away)  (States) by_neither    (by_vision) (nor) (by_culture) (moral_roots_to_be_put_away)  (States)
...
\glb    going_to_building_up  States   going_to_pulling_down   (States) going_to_neither_(building_up_nor_pulling_down) (States)
...
\glb    of_one_in_training     States   of_the_adept   (States) of_one_who_is_neither_(in_training_nor_adept) (States)
...
\glb    having_limited_object     States   having_sublime_object     (States) having_infinite_object   (States)
\ex     States that have a limited object; a sublime object; an infinite object.
```
...
\glb    wrong_fixed_as_to_consequences States   right_fixed_as_to_consequences (States) not_fixed    (States)
...
\glb    having_Path_as_object        States   having_Path_as_root          (States) having_Path_as_dominance       (States)
...
\glb    arisen         States   not_arisen         (States) bound_to_arise       (States)
...
\ex     States that are past; future; present.
```
...
\glb    having_past_object      States   having_future_object    (States) having_present_object   (States)
\ex     States that have the past as their object; the future as their object; the present as their object.
```
...
\glb    personal     States   external     (States) both_(personal_and_external) (States)
\ex     States that belong to one's self; are external to one's self; are both.
```
...
\glb    having_personal_object  States   having_external_object  (States) having_both_(personal_and_external)_object (States)
...
\glb    visible_and_reacting    States   invisible_and_reacting  (States) invisible_and_nonreacting (States)
\ex     States that are visible and reacting; invisible and reacting; invisible and non-reacting.
```
