...
\glb    Which   states   indeterminate   wholesome_and_unwholesome   states   results   sense-sphere   fine-material_sphere   immaterial_sphere   unincluded   feeling   perception   formations   consciousness   those   and   states   functional   neither   wholesome   unwholesome   not   and   results_of_kamma   all   form   unconditioned   and   element   these   states   indeterminate
\ex     Which states are indeterminate? The results of wholesome and unwholesome states in the sense-sphere, fine-material sphere, immaterial sphere, or unincluded, as the aggregates of feeling, perception, mental formations, and consciousness; and those functional states which are neither wholesome nor unwholesome, and not results of kamma; and all form; and the unconditioned element—these states are indeterminate.
```
...
\glb    In_this_connection   what   all   form   four   and   great_primary_elements   four   great_primary_elements   derived   form   this   called   all   form   all   form   not   root   rootless   dissociated_from_roots   with_conditions   conditioned   form   mundane   with_taints   binding   fettering   deluging   yoking   obstructing   grasped   clung_to   --   indeterminate   without_object   --   --   --   --   not   --   not   --   --   not   --   not   --   not   --   neither   seeing   not   development   --   neither   seeing   not   development   --   neither   leading_to_accumulation   not   --   --   limited   --   not   --   not   --   included   not   unincluded   unfixed   not_leading_to_liberation   arisen   six   consciousnesses   --   --   --   Thus   in_one_way   compendium   Monads
\ex     In this connection, what is all form? The four great primary elements, and form derived from the four great primary elements—this is called all form. All form is not a root, rootless, dissociated from roots, with conditions, conditioned, form, mundane, with taints, binding, fettering, deluging, yoking, obstructing, grasped, clung to, defiling, indeterminate, without object, without mental factors, dissociated from consciousness, neither result nor result-producing, undefiled but defiling, not with initial and sustained application, not merely with sustained application, without initial and sustained application, not accompanied by zest, not accompanied by happiness, not accompanied by equanimity, not to be abandoned by seeing nor by development, not having roots to be abandoned by seeing nor by development, neither leading to accumulation nor diminution, neither trainee nor adept, limited, belonging to the sense-sphere, not fine-material, not immaterial, included, not unincluded, unfixed, not leading to liberation, arisen, knowable by the six consciousnesses, impermanent, overcome by decay. Thus, the compendium of form in one way. The Monads.
```
...
\glb    threefold   collection   That   that   matter   internal   that   clung_to   That   that   matter   external   that   is   clung_to   is   not   clung_to   That   that   matter   internal   that   clung_to   That   that   matter   external   that   is   clung_to   is   not_clung_to   That   that   matter   internal   that   clung_to   That   that   matter   external   that   is   clung_to   is   not_clung_to   That   that   matter   internal   that   non-visible   That   that   matter   external   that   is   visible   is   non-visible   That   that   matter   internal   that   impinging   That   that   matter   external   that   is   impinging   is   non-impinging   That   that   matter   internal   that   faculty   That   that   matter   external   that   is   faculty   is   not   faculty   That   that   matter   internal   that   not   great_element   That   that   matter   external   that   is   great_element   is   not   great_element   That   that   matter   internal   that   not   intimation   That   that   matter   external   that   is   intimation   is   not   intimation   That   that   matter   internal   that   not   mind-originated   That   that   matter   external   that   is   mind-originated   is   not   mind-originated   That   that   matter   internal   that   not   co-arises   That   that   matter   external   that   is   co-arises   is   not   co-arises   That   that   matter   internal   that   not   follows   That   that   matter   external   that   is   follows   is   not   follows   That   that   matter   internal   that   gross   That   that   matter   external   that   is   gross   is   subtle   That   that   matter   internal   that   near   That   that   matter   external   that   is   far   is   near   That   that   matter   external   that   eye-contact   not   base   That   that   matter   internal   that   is   eye-contact   base   is   eye-contact   not   base   That   that   matter   external   that   born_of_eye-contact   --   --   --   eye-consciousness   not   base   That   that   matter   internal   that   is   eye-consciousness   base   is   eye-consciousness   not   base   That   that   matter   external   that   --   --   --   body-contact   not   base   That   that   matter   internal   that   is   body-contact   base   is   body-contact   not   base   That   that   matter   external   that   born_of_body-contact   --   --   --   body-consciousness   not   base   That   that   matter   internal   that   is   body-consciousness   base   is   body-consciousness   not   base   That   that   matter   internal   that   eye-contact   object   That   that   matter   external   that   is   eye-contact   object   is   eye-contact   object   That   that   matter   internal   that   born_of_eye-contact   --   --   --   eye-consciousness   object   That   that   matter   external   that   is   eye-consciousness   object   is   eye-consciousness   object   That   that   matter   internal   that   --   --   --   body-contact   object   That   that   matter   external   that   is   body-contact   object   is   body-contact   object   That   that   matter   internal   that   born_of_body-contact   --   --   --   body-consciousness   object   That   that   matter   external   that   is   body-consciousness   object   is   body-consciousness   object   That   that   matter   external   that   not   eye-base   That   that   matter   internal   that   is   eye-base   is   not   eye-base   That   that   matter   external   that   not   --   not   --   not   --   not   body-base   That   that   matter   internal   that   is   body-base   is   not   body-base   That   that   matter   internal   that   not   visible-form-base   That   that   matter   external   that   is   visible-form-base   is   not   visible-form-base   That   that   matter   internal   that   not   --   not   --   not   --   not   tangible-base   That   that   matter   external   that   is   tangible-base   is   not   tangible-base   That   that   matter   external   that   not   eye-element   That   that   matter   internal   that   is   eye-element   is   not   eye-element   That   that   matter   external   that   not   --   not   --   not   --   not   body-element   That   that   matter   internal   that   is   body-element   is   not   body-element   That   that   matter   internal   that   not   visible-form-element   That   that   matter   external   that   is   visible-form-element   is   not   visible-form-element   That   that   matter   internal   that   not   --   not   --   not   --   not   tangible-element   That   that   matter   external   that   is   tangible-element   is   not   tangible-element   That   that   matter   external   that   not   eye-faculty   That   that   matter   internal   that   is   eye-faculty   is   not   eye-faculty   That   that   matter   external   that   not   --   not   --   not   --   not   body-faculty   That   that   matter   internal   that   is   body-faculty   is   not   body-faculty   That   that   matter   internal   that   not   female-faculty   That   that   matter   external   that   is   female-faculty   is   not   female-faculty   That   that   matter   internal   that   not   male-faculty   That   that   matter   external   that   is   male-faculty   is   not   male-faculty   That   that   matter   internal   that   not   life_faculty   That   that   matter   external   that   is   life_faculty   is   not   life_faculty   That   that   matter   internal   that   not   bodily_intimation   That   that   matter   external   that   is   bodily_intimation   is   not   bodily_intimation   That   that   matter   internal   that   not   verbal_intimation   That   that   matter   external   that   is   verbal_intimation   is   not   verbal_intimation   That   that   matter   internal   that   not   space_element   That   that   matter   external   that   is   space_element   is   not   space_element   That   that   matter   internal   that   not   water_element   That   that   matter   external   that   is   water_element   is   not   water_element   That   that   matter   internal   that   of   not   lightness   That   that   matter   external   that   is   of   lightness   is   of   not   lightness   That   that   matter   internal   that   of   not   malleability   That   that   matter   external   that   is   of   malleability   is   of   not   malleability   That   that   matter   internal   that   of   not   wieldiness   That   that   matter   external   that   is   of   wieldiness   is   of   not   wieldiness   That   that   matter   internal   that   of   not   production   That   that   matter   external   that   is   of   production   is   of   not   production   That   that   matter   internal   that   of   not   continuity   That   that   matter   external   that   is   of   continuity   is   of   not   continuity   That   that   matter   internal   that   of   not   decay   That   that   matter   external   that   is   of   decay   is   of   not   decay   That   that   matter   internal   that   of   not   impermanence   That   that   matter   external   that   is   of   impermanence   is   of   not   impermanence   That   that   matter   internal   that   not   edible   food   That   that   matter   external   that   is   edible   food   is   not   edible   food   Thus   threefold   collection   Triads
...
\glb    fourfold   compendium   That   that   matter   derived   that   is   grasped   is   not_grasped   That   that   matter   not   derived   that   is   grasped   is   not_grasped   That   that   matter   derived   that   is   grasped   is   not_grasped   That   that   matter   not   derived   that   is   grasped   is   not_grasped   That   that   matter   derived   that   is   with_impact   is   without_impact   That   that   matter   not   derived   that   is   with_impact   is   without_impact   That   that   matter   derived   that   is   gross   is   subtle   That   that   matter   not   derived   that   is   gross   is   subtle   That   that   matter   derived   that   is   far   is   near   That   that   matter   not   derived   that   is   far   is   near   That   that   matter   grasped   that   is   visible   is   invisible   That   that   matter   not_grasped   that   is   visible   is   invisible   That   that   matter   grasped   that   is   with_impact   is   without_impact   That   that   matter   not_grasped   that   is   with_impact   is   without_impact   That   that   matter   grasped   that   is   great_element   is   not   great_element   That   that   matter   not_grasped   that   is   great_element   is   not   great_element   That   that   matter   grasped   that   is   gross   is   subtle   That   that   matter   not_grasped   that   is   gross   is   subtle   That   that   matter   grasped   that   is   far   is   near   That   that   matter   not_grasped   that   is   far   is   near   That   that   matter   grasped   that   is   visible   is   invisible   That   that   matter   not_grasped   that   is   visible   is   invisible   That   that   matter   grasped   that   is   with_impact   is   without_impact   That   that   matter   not_grasped   that   is   with_impact   is   without_impact   That   that   matter   grasped   that   is   great_element   is   not   great_element   That   that   matter   not_grasped   that   is   great_element   is   not   great_element   That   that   matter   grasped   that   is   gross   is   subtle   That   that   matter   not_grasped   that   is   gross   is   subtle   That   that   matter   grasped   that   is   far   is   near   That   that   matter   not_grasped   that   is   far   is   near   That   that   matter   with_impact   that   is   faculty   is   not   faculty   That   that   matter   without_impact   that   is   faculty   is   not   faculty   That   that   matter   with_impact   that   is   great_element   is   not   great_element   That   that   matter   without_impact   that   is   great_element   is   not   great_element   That   that   matter   faculty   that   is   gross   is   subtle   That   that   matter   not   faculty   that   is   gross   is   subtle   That   that   matter   faculty   that   is   far   is   near   That   that   matter   not   faculty   that   is   far   is   near   That   that   matter   great_element   that   is   gross   is   subtle   That   that   matter   not   great_element   that   is   gross   is   subtle   That   that   matter   great_element   that   is   far   is   near   That   that   matter   not   great_element   that   is   far   is   near   --   --   --   --   matter   Thus   fourfold   compendium   --
...
```gloss
\gla    Pañcavidhena   rūpasaṅgaho   Pathavīdhātu   āpodhātu   tejodhātu   vāyodhātu   yañca   rūpaṃ   upādā   Evaṃ   pañcavidhena   rūpasaṅgaho   Pañcakaṃ
\glb    fivefold   compendium   earth_element   water_element   fire_element   wind_element   and   matter   derived   Thus   fivefold   compendium   --
\ex     Earth element, water element, fire element, wind element, and derived matter. Thus is the fivefold compendium of matter. The Fivefold.
```

## ^1-588

```gloss
\gla    Chabbidhena   rūpasaṅgaho   Cakkhuviññeyyaṃ   rūpaṃ   sotaviññeyyaṃ   rūpaṃ   ghānaviññeyyaṃ   rūpaṃ   jivhāviññeyyaṃ   rūpaṃ   kāyaviññeyyaṃ   rūpaṃ   manoviññeyyaṃ   rūpaṃ   Evaṃ   chabbidhena   rūpasaṅgaho   Chakkaṃ
\glb    sixfold   compendium   visible_form   matter   sound_form   matter   odour_form   matter   taste_form   matter   --   matter   --   matter   Thus   sixfold   compendium   Sixfold
\ex     Visible form, sound, odour, taste, tangibles, mind-perceptible matter. Thus, the sixfold compendium of matter. The Sixfold.
```

## ^1-589

```gloss
\gla    Sattavidhena   rūpasaṅgaho   Cakkhuviññeyyaṃ   rūpaṃ   sotaviññeyyaṃ   rūpaṃ   ghānaviññeyyaṃ   rūpaṃ   jivhāviññeyyaṃ   rūpaṃ   kāyaviññeyyaṃ   rūpaṃ   manodhātuviññeyyaṃ   rūpaṃ   manoviññāṇadhātuviññeyyaṃ   rūpaṃ   Evaṃ   sattavidhena   rūpasaṅgaho   Sattakaṃ
\glb    sevenfold   compendium   visible_form   matter   sound_form   matter   odour_form   matter   taste_form   matter   --   matter   --   matter   mind-consciousness   matter   Thus   sevenfold   compendium   Sevenfold
\ex     Visible form, sound, odour, taste, tangibles, matter perceptible by the mind-element, matter perceptible by the mind-consciousness element. Thus, the sevenfold compendium of matter. The Sevenfold.
```

## ^1-590

```gloss
\gla    Aṭṭhavidhena   rūpasaṅgaho   Cakkhuviññeyyaṃ   rūpaṃ   sotaviññeyyaṃ   rūpaṃ   ghānaviññeyyaṃ   rūpaṃ   jivhāviññeyyaṃ   rūpaṃ   kāyaviññeyyaṃ   rūpaṃ   atthi   sukhasamphassaṃ   atthi   dukkhasamphassaṃ   manodhātuviññeyyaṃ   rūpaṃ   manoviññāṇadhātuviññeyyaṃ   rūpaṃ   Evaṃ   aṭṭhavidhena   rūpasaṅgaho   Aṭṭhakaṃ
\glb    eightfold   classification   visible_form   material   sound_form   material   odour_form   material   taste_form   material   tangible_form   material   --   pleasant_contact   --   painful_contact   mind-element_cognizable   material   mind-consciousness-element_cognizable   material   Thus   eightfold   classification   Octad
\ex     Visible form, sound, odour, taste, tangible, pleasant contact, painful contact, mind-element cognizable form, mind-consciousness-element cognizable form. Thus, the eightfold classification of material phenomena. The Octad.
```

## ^1-591

```gloss
\gla    Navavidhena   rūpasaṅgaho   Cakkhundriyaṃ   sotindriyaṃ   ghānindriyaṃ   jivhindriyaṃ   kāyindriyaṃ   itthindriyaṃ   purisindriyaṃ   jīvitindriyaṃ   yañca   rūpaṃ   na   indriyaṃ   Evaṃ   navavidhena   rūpasaṅgaho   Navakaṃ
\glb    ninefold   classification   eye-faculty   ear-faculty   nose-faculty   tongue-faculty   body-faculty   femininity_faculty   masculinity_faculty   life_faculty   and   material   not   faculty   Thus   ninefold   classification   Nonad
\ex     Eye faculty, ear faculty, nose faculty, tongue faculty, body faculty, femininity faculty, masculinity faculty, life faculty, and that material phenomenon which is not a faculty. Thus, the ninefold classification of material phenomena. The Nonad.
```

## ^1-592

```gloss
\gla    Dasavidhena   rūpasaṅgaho   Cakkhundriyaṃ   sotindriyaṃ   ghānindriyaṃ   jivhindriyaṃ   kāyindriyaṃ   itthindriyaṃ   purisindriyaṃ   jīvitindriyaṃ   na   indriyaṃ   rūpaṃ   atthi   sappaṭighaṃ   atthi   appaṭighaṃ   Evaṃ   dasavidhena   rūpasaṅgaho   Dasakaṃ
\glb    tenfold   classification   eye-faculty   ear-faculty   nose-faculty   tongue-faculty   body-faculty   femininity_faculty   masculinity_faculty   life_faculty   not   faculty   matter   are   with_impact   are   without_impact   Thus   tenfold   classification   --
\ex     Eye faculty, ear faculty, nose faculty, tongue faculty, body faculty, femininity faculty, masculinity faculty, life faculty, material phenomena that are not faculties, with impact, material phenomena that are not faculties, without impact. Thus, the tenfold classification of matter. Tenfold.
```

## ^1-593

```gloss
\gla    Ekādasavidhena   rūpasaṅgaho   Cakkhāyatanaṃ   sotāyatanaṃ   ghānāyatanaṃ   jivhāyatanaṃ   kāyāyatanaṃ   rūpāyatanaṃ   saddāyatanaṃ   gandhāyatanaṃ   rasāyatanaṃ   phoṭṭhabbāyatanaṃ   yañca   rūpaṃ   anidassanaappaṭighaṃ   dhammāyatanapariyāpannaṃ   Evaṃ   ekādasavidhena   rūpasaṅgaho   Ekādasakaṃ   Mātikā
\glb    elevenfold   classification   eye-base   ear-base   nose-base   tongue-base   body-base   visible-form-base   sound-base   smell-base   taste-base   tangible-base   and   matter   invisible_without_impact   dhamma_base_included   Thus   elevenfold   classification   Elevenfold   Matika
\ex     Eye base, ear base, nose base, tongue base, body base, visible form base, sound base, smell base, taste base, tangible base, and that material phenomenon which is invisible, without impact, and included in the dhamma base. Thus, the elevenfold classification of matter. Elevenfold. Matika.
```

## ^1-594

```gloss
\gla    Sabbaṃ   rūpaṃ   na   hetumeva   ahetukameva   hetuvippayuttameva   sappaccayameva   saṅkhatameva   rūpameva   lokiyameva   sāsavameva   saṃyojaniyameva   ganthaniyameva   oghaniyameva   yoganiyameva   nīvaraṇiyameva   parāmaṭṭhameva   upādāniyameva   saṃkilesikameva   abyākatameva   anārammaṇameva   acetasikameva   cittavippayuttameva   nevavipākanavipākadhammadhammameva   asaṃkiliṭṭhasaṃkilesikameva   na   savitakkasavicārameva   na   avitakkavicāramattameva   avitakkaavicārameva   na   pītisahagatameva   na   sukhasahagatameva   na   upekkhāsahagatameva   neva   dassanena   na   bhāvanāya   pahātabbameva   neva   dassanena   na   bhāvanāya   pahātabbahetukameva   neva   ācayagāmi   na   apacayagāmimeva   nevasekkhanāsekkhameva   parittameva   kāmāvacarameva   na   rūpāvacarameva   na   arūpāvacarameva   pariyāpannameva   no   apariyāpannameva   aniyatameva   aniyyānikameva   uppannaṃ   chahi   viññāṇehi   viññeyyameva   aniccameva   jarābhibhūtameva   Evaṃ   ekavidhena   rūpasaṅgaho   Ekakaniddeso
\glb    all   material   not   --   --   --   --   --   --   --   --   --   --   --   --   --   --   --   --   --   --   --   --   --   --   not   --   not   --   --   not   --   not   --   not   --   neither   seeing   not   development   --   neither   seeing   not   development   --   neither   leading_to_accumulation   not   --   --   --   --   not   --   not   --   --   not   --   --   --   arisen   six   consciousnesses   --   --   --   Thus   --   compendium   --
\ex     All materiality is not a root, rootless, dissociated from roots, with conditions, conditioned, material, mundane, subject to taints, fettering, binding, of the floods, of the bonds, of the hindrances, grasped, of clinging, defiling, indeterminate, not an object, not mental, dissociated from consciousness, neither resultant nor productive of results, undefiled but defiling, not with initial and sustained application, not merely with sustained application, without initial and sustained application, not accompanied by zest, not accompanied by pleasure, not accompanied by equanimity, not to be abandoned by seeing nor by development, not having causes to be abandoned by seeing nor by development, neither tending to accumulation nor to diminution, neither trainee nor beyond training, limited, belonging to the sense-sphere, not belonging to the fine-material sphere, not belonging to the immaterial sphere, included, not unincluded, unfixed, not leading to liberation, arisen, knowable by the six consciousnesses, impermanent, overcome by decay. Thus is the compendium of materiality by way of single attributes. Section on Unities.
```
...
\glb    What   that   matter   derived   eye-base   ear-base   nose-base   tongue-base   body-base   visible   sound-base   smell-base   taste-base   femininity_faculty   masculinity_faculty   life_faculty   bodily_intimation   vocal_intimation   space_element   of   lightness   of   malleability   of   wieldiness   of   production   of   continuity   of   decay   of   impermanence   edible   food
\ex     What is that derived materiality? Eye-base, ear-base, nose-base, tongue-base, body-base, visible object-base, sound-base, smell-base, taste-base, femininity faculty, masculinity faculty, life faculty, bodily intimation, vocal intimation, space element, lightness of matter, malleability of matter, wieldiness of matter, production of matter, continuity of matter, decay of matter, impermanence of matter, edible food.
```
...
\glb    What   that   matter   eye-base   That   eye   four   great_primary_elements   derived   sensitivity   included   invisible   impinging   by_which   eye   invisible   impinging   matter   visible   impinging   seen   or   sees   or   will_see   or   may_see   or   eye   this   eye-base   this   eye_element   this   eye-faculty   this   world   this   door   this   ocean   this   lucent   this   field   this   base   this   guide   this   sight   this   hither   shore   this   empty   village   this   that   matter   eye-base
\ex     What is that materiality which is the eye-base? That eye, which is a sensitivity derived from the four great primary elements, included within one's own being, invisible, and impinging; by which eye, invisible and impinging, one has seen, sees, will see, or may see visible and impinging matter. This is the eye, this is the eye-base, this is the eye element, this is the eye faculty, this is the world, this is a door, this is an ocean, this is lucent, this is a field, this is a base, this is a guide, this is sight, this is the hither shore, this is an empty village – this is that materiality which is the eye-base.
```
...
\glb    What   that   matter   eye-base   That   eye   four   great_primary_elements   derived   sensitivity   included   invisible   impinging   which   eye   invisible   impinging   matter   visible   impinging   impinged   or   impinges   or   will_impinge   or   may_impinge   or   eye   this   eye-base   this   eye_element   this   eye-faculty   this   world   this   door   this   ocean   this   lucent   this   field   this   base   this   guide   this   sight   this   hither   shore   this   empty   village   this   this   that   matter   eye-base
\ex     What is that materiality which is the eye-base? That eye, which is a sensitivity derived from the four great primary elements, included within one's own being, invisible, and impinging; on which eye, invisible and impinging, visible and impinging matter has impinged, impinges, will impinge, or may impinge. This is the eye, this is the eye-base, this is the eye element, this is the eye faculty, this is the world, this is a door, this is an ocean, this is lucent, this is a field, this is a base, this is a guide, this is sight, this is the hither shore, this is an empty village – this is that materiality which is the eye-base.
```
...
\glb    What   that   matter   eye-base   That   eye   four   great_elements   derived   sensitive_matter   included   invisible   with_impingement   that   eye   based   matter   object   eye-contact   arose   or   arises   or   will_arise   or   might_arise   --   that   eye   based   matter   object   born_of_eye-contact   --   --   --   eye-consciousness   arose   or   arises   or   will_arise   or   might_arise   --   that   eye   based   object   eye-contact   arose   or   arises   or   will_arise   or   might_arise   --   that   eye   based   object   born_of_eye-contact   --   --   --   eye-consciousness   arose   or   arises   or   will_arise   or   might_arise   or   eye   this   eye-base   this   eye-element   this   eye-faculty   this   world   this   door   this   ocean   this   white   this   field   this   base   this   eye   this   eye   this   near_shore   shore   this   empty   village   this   this   that   matter   eye-base
...
\glb    What   that   matter   ear-base   That   ear   four   great_elements   derived   sensitive_matter   included   invisible   with_impingement   which   ear   invisible   with_impingement   sound   invisible   with_impingement   impinged   or   impinges   or   will_impinge   or   impingement   or   ear   this   ear-base   this   ear-element   this   ear-faculty   this   world   this   door   this   ocean   this   white   this   field   this   base   this   near_shore   shore   this   empty   village   this   this   that   matter   ear-base
...
\glb    What   that   matter   ear-base   That   ear   four   great_elements   derived   sensitive_matter   included   invisible   with_impingement   that   ear   invisible   with_impingement   sound   invisible   with_impingement   impinged   or   impinges   or   will_impinge   or   impingement   or   ear   this   ear-base   this   ear-element   this   ear-faculty   this   world   this   door   this   ocean   this   white   this   field   this   base   this   near_shore   shore   this   empty   village   this   this   that   matter   ear-base
...
\glb    What   that   matter   ear-base   That   ear   four   great_elements   derived   sensitive_matter   included   invisible   with_impingement   that   ear   based   sound   object   ear-contact   arose   or   arises   or   will_arise   or   might_arise   --   that   ear   based   sound   object   born_of_ear-contact   --   --   --   ear-consciousness   arose   or   arises   or   will_arise   or   might_arise   --   that   ear   based   sound_object   ear-contact   arose   or   arises   or   will_arise   or   might_arise   --   that   ear   based   sound_object   born_of_ear-contact   --   --   --   ear-consciousness   arose   or   arises   or   will_arise   or   might_arise   or   ear   this   ear-base   this   ear-element   this   ear-faculty   this   world   this   door   this   ocean   this   white   this   field   this   base   this   near_shore   shore   this   empty   village   this   this   that   matter   ear-base
...
\glb    What   that   matter   nose-base   That   nose   four   great_elements   derived   sensitive_matter   included   invisible   with_impingement   which   nose   invisible   with_impingement   odour   invisible   with_impingement   impinged   or   impinges   or   will_impinge   or   impingement   or   nose   this   nose-base   this   nose-element   this   nose-faculty   this   world   this   door   this   ocean   this   white   this   field   this   base   this   near_shore   shore   this   empty   village   this   this   that   matter   nose-base
...
\glb    What   that   matter   nose-base   That   nose   four   great_elements   derived   sensitive_matter   included   invisible   with_impingement   that   nose   invisible   with_impingement   --   invisible   with_impingement   impinged   or   impinges   or   will_impinge   or   impingement   or   nose   this   nose-base   this   nose-element   this   nose-faculty   this   world   this   door   this   ocean   this   white   this   field   this   base   this   near_shore   shore   this   empty   village   this   that   matter   nose-base
...
\glb    What   that   matter   nose-base   That   nose   four   great_elements   derived   sensitive_matter   included   invisible   with_impingement   that   nose   based   odour   object   nose-contact   arose   or   arises   or   will_arise   or   might_arise   --   that   nose   based   odour   object   born_of_nose-contact   --   --   --   nose-consciousness   arose   or   arises   or   will_arise   or   might_arise   --   that   nose   based   --   nose-contact   arose   or   arises   or   will_arise   or   might_arise   --   that   nose   based   --   born_of_nose-contact   --   --   --   nose-consciousness   arose   or   arises   or   will_arise   or   might_arise   or   nose   this   nose-base   this   nose-element   this   nose-faculty   this   world   this   door   this   ocean   this   white   this   field   this   base   this   near_shore   shore   this   empty   village   this   this   that   matter   nose-base
...
\glb    What   that   matter   tongue-base   That   tongue   four   great_primaries   derived   sensitive_matter   included   invisible   with_impingement   which   tongue   invisible   impingement   taste   invisible   with_impingement   impinged   or   impinges   or   will_impinge   or   may_impinge   or   tongue   this   tongue-base   this   tongue_element   this   tongue-faculty   this   world   this   door   this   ocean   this   white   this   field   this   base   this   hither   shore   this   empty   village   this   this   that   matter   tongue-base
...
\glb    What   that   matter   tongue-base   That   tongue   four   great_primaries   derived   sensitive_matter   included   invisible   with_impingement   that   tongue   invisible   impingement   taste   invisible   with_impingement   impinged   or   impinges   or   will_impinge   or   may_impinge   or   tongue   this   tongue-base   this   tongue_element   this   tongue-faculty   this   world   this   door   this   ocean   this   white   this   field   this   base   this   hither   shore   this   empty   village   this   this   that   matter   tongue-base
...
\glb    What   that   matter   tongue-base   That   tongue   four   great_primaries   derived   sensitive_matter   included   invisible   with_impingement   that   tongue   depending   taste   object   tongue-contact   arisen   or   arises   or   will_arise   or   may_arise   --   that   tongue   depending   taste   object   born_of_gustatory-contact   --   --   --   tongue-consciousness   arisen   or   arises   or   will_arise   or   may_arise   --   that   tongue   depending   taste_object   tongue-contact   arisen   or   arises   or   will_arise   or   may_arise   --   that   tongue   depending   taste_object   born_of_gustatory-contact   --   --   --   tongue-consciousness   arisen   or   arises   or   will_arise   or   may_arise   or   tongue   this   tongue-base   this   tongue_element   this   tongue-faculty   this   world   this   door   this   ocean   this   white   this   field   this   base   this   hither   shore   this   empty   village   this   this   that   matter   tongue-base
...
\glb    What   that   matter   body-base   That   body   four   great_primaries   derived   sensitive_matter   included   invisible   with_impingement   by_which   body   invisible   impingement   tangible   --   touched   or   touches   or   will_touch   or   may_touch   or   body   this   body-base   this   body_element   this   body-faculty   this   world   this   door   this   ocean   this   white   this   field   this   base   this   hither   shore   this   empty   village   this   this   that   matter   body-base
...
\glb    What   that   matter   body-base   That   body   four   great_primaries   derived   sensitive_matter   included   invisible   with_impingement   which   body   invisible   with_impingement   tangible   invisible   with_impingement   impinged   or   impinges   or   will_impinge   or   may_impinge   or   body   this   body-base   this   body_element   this   body-faculty   this   world   this   door   this   ocean   this   white   this   field   this   base   this   hither   shore   this   empty   village   this   this   that   matter   body-base
...
\glb    What   that   matter   body-base   That   body   four   great_primaries   derived   sensitive_matter   included   invisible   with_impingement   that   body   invisible   with_impingement   tangible   invisible   with_impingement   impinged   or   impinges   or   will_impinge   or   may_impinge   or   body   this   body-base   this   body_element   this   body-faculty   this   world   this   door   this   ocean   this   white   this   field   this   base   this   hither   shore   this   empty   village   this   this   that   matter   body-base
...
\glb    What   that   matter   body-base   That   body   four   great_primaries   derived   sensitive_matter   included   invisible   with_impingement   that   body   depending   tangible   object   body-contact   arisen   or   arises   or   will_arise   or   may_arise   --   that   body   depending   tangible   object   born_of_body-contact   --   --   --   body-consciousness   arisen   or   arises   or   will_arise   or   may_arise   --   that   body   depending   tangible_object   body-contact   arisen   or   arises   or   will_arise   or   may_arise   --   that   body   depending   tangible_object   born_of_body-contact   --   --   --   body-consciousness   arisen   or   arises   or   will_arise   or   may_arise   or   body   this   body-base   this   body_element   this   body-faculty   this   world   this   door   this   ocean   this   white   this   field   this   base   this   hither   shore   this   empty   village   this   this   that   matter   body-base
...
\glb    What   that   material   visible-form-base   That   material   four   great_primaries   derived   color   visible   with_impingement   blue   yellow   red   white   black   crimson   green   green   mango-bud_color   long   short   small   large   round   circular   square   hexagonal   octagonal   sixteen-sided   low   high   shadow   sunlight   light   darkness   cloud   mist   smoke   dust   moon   color   sun   color   stars   color   mirror   color   gem   color   gold   color   that   or   other   is   material   four   great_primaries   derived   color   visible   with_impingement   that   material   visible   with_impingement   eye   invisible   impingement   seen   or   sees   or   will_see   or   may_see   or   material   this   visible-form-base   this   visible_form_element   this   this   that   material   visible-form-base
...
\glb    What   that   material   visible-form-base   That   material   four   great_primaries   derived   color   visible   with_impingement   blue   yellow   red   white   black   crimson   green   green   mango-bud_color   long   short   small   large   round   circular   square   hexagonal   octagonal   sixteen-sided   low   high   shadow   sunlight   light   darkness   cloud   mist   smoke   dust   moon   color   sun   color   stars   color   mirror   color   gem   color   gold   color   that   or   other   is   material   four   great_primaries   derived   color   visible   with_impingement   which   material   visible   with_impingement   eye   invisible   with_impingement   impinged   or   impinges   or   will_impinge   or   may_impinge   or   material   this   visible-form-base   this   visible_form_element   this   this   that   material   visible-form-base
...
\glb    What   that   matter   visible_object_base   That   matter   four   great_elements   derived   luster   visible   impinging   blue   yellow   red   white   black   crimson   green   green   mango-bud_color   long   short   minute   coarse   round   circular   square   hexagonal   octagonal   sixteen-sided   depression   elevation   shadow   sunlight   light   darkness   cloud   mist   smoke   dust   moon   luster   sun   luster   star_forms   luster   mirror   luster   gems   luster   gold   luster   that   or   other   is   matter   four   great_elements   derived   luster   visible   impinging   that   matter   visible   impinging   eye   invisible   impinging   impinged   or   impinges   or   will_impinge   or   may_impinge   or   matter   this   visible_object_base   this   visible   this   this   that   matter   visible_object_base
...
\glb    What   that   matter   sound-base   That   sound   four   great_elements   derived   invisible   impinging   drum_sound   tabor_sound   conch_sound   instrumental_music   singing   instrumental_music   clapping   manual_sounds   beings   sounds_of_living_beings   elements   colliding_elements   wind_sound   water_sound   human_sound   non-human_sound   that   or   other   is   sound   four   great_elements   derived   invisible   impinging   that   sound   invisible   impinging   ear   invisible   impinging   heard   or   hears   or   will_hear   or   may_hear   or   sound   this   sound-base   this   sound_element   this   this   that   matter   sound-base
...
\glb    What   that   matter   sound-base   That   sound   four   great_elements   derived   invisible   impinging   drum_sound   tabor_sound   conch_sound   instrumental_music   singing   instrumental_music   clapping   manual_sounds   beings   sounds_of_living_beings   elements   colliding_elements   wind_sound   water_sound   human_sound   non-human_sound   that   or   other   is   sound   four   great_elements   derived   invisible   impinging   that   sound   object   ear   relying   ear-contact   arose   or   arises   or   will_arise   or   may_arise   --   that   sound   object   ear   relying   born_of_ear-contact   --   --   --   ear-consciousness   arose   or   arises   or   will_arise   or   may_arise   --   that   sound_object   ear   relying   ear-contact   arose   or   arises   or   will_arise   or   may_arise   --   that   sound_object   ear   relying   born_of_ear-contact   --   --   --   ear-consciousness   arose   or   arises   or   will_arise   or   may_arise   or   sound   this   sound-base   this   sound_element   this   this   that   matter   sound-base
...
\glb    What   that   matter   smell-base   That   smell   four   great_elements   derived   invisible   impinging   root_odor   wood_odor   bark_odor   leaf_odor   flower_odor   fruit_odor   raw_odor   putrid_odor   pleasant_odor   unpleasant_odor   that   or   other   is   smell   four   great_elements   derived   invisible   impinging   that   smell   invisible   impinging   nose   invisible   impinging   smelled   or   smells   or   will_smell   or   may_smell   or   smell   this   smell-base   this   smell_element   this   this   that   matter   smell-base
...
\glb    What   that   matter   odor-base   That   odor   four   great_elements   derived   invisible   impinging   root_odor   wood_odor   bark_odor   leaf_odor   flower_odor   fruit_odor   raw_odor   putrid_odor   pleasant_odor   unpleasant_odor   that   or   other   is   odor   four   great_elements   derived   invisible   impinging   which   odor   invisible   impinging   nose   invisible   impinging   impinged   or   impinges   or   will_impinge   or   may_impinge   or   odor   this   odor-base   this   odor-element   this   this   that   matter   odor-base
...
\glb    What   that   matter   odor-base   That   odor   four   great_elements   derived   invisible   impinging   root_odor   wood_odor   bark_odor   leaf_odor   flower_odor   fruit_odor   raw_odor   putrid_odor   pleasant_odor   unpleasant_odor   that   or   other   is   odor   four   great_elements   derived   invisible   impinging   that   odor   invisible   impinging   nose   invisible   impinging   impinged   or   impinges   or   will_impinge   or   may_impinge   or   odor   this   odor-base   this   odor-element   this   this   that   matter   odor-base
...
\glb    What   that   matter   odor-base   That   odor   four   great_elements   derived   invisible   impinging   root_odor   wood_odor   bark_odor   leaf_odor   flower_odor   fruit_odor   raw_odor   putrid_odor   pleasant_odor   unpleasant_odor   that   or   other   is   odor   four   great_elements   derived   invisible   impinging   that   odor   object   nose   relying   nose-contact   arose   or   arises   or   will_arise   or   may_arise   --   that   odor   object   nose   relying   born_of_nose-contact   --   --   --   nose-consciousness   arose   or   arises   or   will_arise   or   may_arise   --   that   odor_object   nose   relying   nose-contact   arose   or   arises   or   will_arise   or   may_arise   --   that   odor_object   nose   relying   born_of_nose-contact   --   --   --   nose-consciousness   arose   or   arises   or   will_arise   or   may_arise   or   odor   this   odor-base   this   odor-element   this   this   that   matter   odor-base
...
\glb    What   that   material   taste-base   That   taste   four   great_primaries   derived   invisible   impinging   root_taste   trunk_taste   bark_taste   leaf_taste   flower_taste   fruit_taste   sour   sweet   bitter   pungent   salty   alkaline   acrid   astringent   agreeable   disagreeable   that   or   other   is   taste   four   great_primaries   derived   invisible   impinging   that   taste   invisible   impinging   tongue   invisible   impinging   tasted   or   tastes   or   will_taste   or   may_taste   or   taste   this   taste-base   this   taste-element   this   this   that   material   taste-base
...
\glb    What   that   material   taste-base   That   taste   four   great_primaries   derived   invisible   impinging   root_taste   trunk_taste   bark_taste   leaf_taste   flower_taste   fruit_taste   sour   sweet   bitter   pungent   salty   alkaline   acrid   astringent   agreeable   disagreeable   that   or   other   is   taste   four   great_primaries   derived   invisible   impinging   which   taste   invisible   impinging   tongue   invisible   impinging   impinged   or   impinges   or   will_impinge   or   may_impinge   or   taste   this   taste-base   this   taste-element   this   this   that   material   taste-base
...
\glb    What   that   material   taste-base   That   taste   four   great_primaries   derived   invisible   impinging   root_taste   trunk_taste   bark_taste   leaf_taste   flower_taste   fruit_taste   sour   sweet   bitter   pungent   salty   alkaline   acrid   astringent   agreeable   disagreeable   that   or   other   is   taste   four   great_primaries   derived   invisible   impinging   that   taste   invisible   impinging   tongue   invisible   impinging   impinged   or   impinges   or   will_impinge   or   may_impinge   or   taste   this   taste-base   this   taste-element   this   this   that   material   taste-base
...
\glb    What   that   material   taste-base   That   taste   four   great_primaries   derived   invisible   impinging   root_taste   trunk_taste   bark_taste   leaf_taste   flower_taste   fruit_taste   sour   sweet   bitter   pungent   salty   alkaline   acrid   astringent   agreeable   disagreeable   that   or   other   is   taste   four   great_primaries   derived   invisible   impinging   that   taste   object   tongue   depending   tongue-contact   arisen   or   arises   or   will_arise   or   may_arise   --   that   taste   object   tongue   depending   born_of_gustatory-contact   --   --   --   tongue-consciousness   arisen   or   arises   or   will_arise   or   may_arise   --   that   taste_object   tongue   depending   tongue-contact   arisen   or   arises   or   will_arise   or   may_arise   --   that   taste_object   tongue   depending   born_of_gustatory-contact   --   --   --   tongue-consciousness   arisen   or   arises   or   will_arise   or   may_arise   or   taste   this   taste-base   this   taste-element   this   this   that   material   taste-base
...
\glb    What   that   material   femininity_faculty   That   female   female_sign   female_mark   female_characteristic   --   --   --   this   that   material   femininity_faculty
\ex     What is the material phenomenon that is the faculty of femininity? That which is of the female, the female sign, female mark, female characteristic, female deportment, femininity, female state—this is that material phenomenon which is the faculty of femininity.
```
...
\glb    What   that   material   masculinity_faculty   That   male   male_sign   male_mark   male_characteristic   male_deportment   masculinity   male_state   this   that   material   masculinity_faculty
\ex     What is the material phenomenon that is the faculty of masculinity? That which is of the male, the male sign, male mark, male characteristic, male deportment, masculinity, male state—this is that material phenomenon which is the faculty of masculinity.
```
...
\glb    What   that   material   life_faculty   That   these   material   phenomena   life   subsistence   maintenance   sustenance   activity   continuance   preservation   life   life_faculty   this   that   material   life_faculty
\ex     What is the material phenomenon that is the life faculty? That which is the duration, subsistence, maintenance, sustenance, activity, continuance, preservation, life, life faculty of these material phenomena—this is that material phenomenon which is the life faculty.
```
...
\glb    What   that   material   bodily_intimation   That   wholesome_mind   or   unwholesome_mind   or   indeterminate_mind   or   advancing   or   retreating   or   looking   or   glancing   or   bending   or   stretching   or   body   stiffening   stiffening   stiffening   intimation   making   making_known   this   that   material   bodily_intimation
...
\glb    What   that   material   vocal_intimation   That   wholesome_mind   or   unwholesome_mind   or   indeterminate_mind   or   speech   voice   enunciation   utterance   noise   making_noises   speech   language   this   called   speech   That   of   speech   intimation   enunciation   articulate_speech   this   that   material   vocal_intimation
...
\glb    What   that   material   space_element   That   space   spatiality   non-obstruction   aperture   aperture   aperture   uncontacted   four   primaries   this   that   material   space_element
\ex     What is the material phenomenon that is the space element? That which is space, spatiality, non-obstruction, aperture, uncontacted by the four great primaries—this is that material phenomenon which is the space element.
```
...
\glb    What   that   matter   of   lightness   That   of   lightness   changeability   non-sluggishness   non-stiffness   this   that   matter   of   lightness
\ex     What is that matter which is the lightness of matter? That lightness of matter which is quick changeability, non-sluggishness, non-stiffness—this is that matter which is the lightness of matter.
```
...
\glb    What   that   matter   of   pliancy   That   of   pliancy   softness   non-harshness   non-rigidity   this   that   matter   of   pliancy
\ex     What is that matter which is the pliancy of matter? That pliancy of matter which is softness, non-harshness, non-rigidity—this is that matter which is the pliancy of matter.
```
...
\glb    What   that   matter   of   wieldiness   That   of   wieldiness   fitness_for_work   suitability   this   that   matter   of   wieldiness
\ex     What is that matter which is the wieldiness of matter? That wieldiness of matter which is fitness for work, suitability—this is that matter which is the wieldiness of matter.
```
...
\glb    What   that   matter   of   growth   That   sense_bases   accumulation   that   of   growth   this   that   matter   of   growth
\ex     What is that matter which is the growth of matter? That which is the accumulation of the sense bases, that is the growth of matter—this is that matter which is the growth of matter.
```
...
\glb    What   that   matter   of   continuity   That   of   growth   that   of   continuity   this   that   matter   of   continuity
\ex     What is that matter which is the continuity of matter? That which is the growth of matter, that is the continuity of matter—this is that matter which is the continuity of matter.
```
...
\glb    What   that   matter   of   decay   That   of   old_age   decay   brokenness   greyness   wrinkling   life   decline   faculties   ripening   this   that   matter   of   decay
\ex     What is that matter which is the decay of matter? That decay of matter which is old age, decay, brokenness, greyness, wrinkling of skin, decline of life, ripening of the faculties—this is that matter which is the decay of matter.
```
...
\glb    What   that   matter   of   impermanence   That   of   destruction   passing_away   breaking_up   complete_breaking_up   impermanence   disappearance   this   that   matter   of   impermanence
\ex     What is that matter which is the impermanence of matter? That impermanence of matter which is destruction, passing away, breaking up, complete breaking up, impermanence, disappearance—this is that matter which is the impermanence of matter.
```
...
\glb    What   that   matter   edible   food   Rice   gruel   flour   fish   meat   milk   curds   ghee   fresh_butter   oil   honey   molasses   that   or   other   is   matter   which   which   country   for   for   beings   swallowed   teeth   throat   stomach   which   nutrient_essence   beings   subsist   this   that   matter   edible   food   this   that   matter   derived   derived_matter   Chapter_on_Materiality   First_section
...
\glb    What   that   materiality   not   clung_to   tangible-base   water_element
\ex     What is that materiality not clung to? The tangible base, the water element.
```
...
\glb    What   that   materiality   tangible-base   earth_element   fire_element   air_element   hard   soft   smooth   rough   pleasant_to_touch   painful_to_touch   heavy   light   that   tangible   non-apparent   impinging   body   non-apparent   impinging   touched   or   touches   or   will_touch   or   may_touch   or   tangible   this   tangible-base   this   tangible_element   this   this   that   materiality   tangible-base
\ex     What is that materiality, the tangible base? The earth element, fire element, air element; hard, soft, smooth, rough, pleasant to touch, painful to touch, heavy, light; that tangible, non-apparent, impinging, which the non-apparent, impinging body has touched, touches, will touch, or may touch—this is that materiality, the tangible base.
```
...
\glb    What   that   materiality   tangible-base   earth_element   fire_element   air_element   hard   soft   smooth   rough   pleasant_to_touch   painful_to_touch   heavy   light   which   tangible   non-apparent   impinging   body   non-apparent   impinging   impinged   or   impinges   or   will_impinge   or   may_impinge   or   tangible   this   tangible-base   this   tangible_element   this   this   that   materiality   tangible-base
...
\glb    What   that   materiality   tangible-base   earth_element   fire_element   air_element   hard   soft   smooth   rough   pleasant_to_touch   painful_to_touch   heavy   light   that   tangible   non-apparent   impinging   body   non-apparent   impinging   impinged   or   impinges   or   will_impinge   or   may_impinge   or   tangible   this   tangible-base   this   tangible_element   this   this   that   materiality   tangible-base
...
\glb    What   that   materiality   tangible-base   earth_element   fire_element   air_element   hard   soft   smooth   rough   pleasant_to_touch   painful_to_touch   heavy   light   that   tangible   object   body   depending   body-contact   arisen   or   arises   or   will_arise   or   may_arise   --   that   tangible   object   body   depending   born_of_body-contact   --   --   --   body-consciousness   arisen   or   arises   or   will_arise   or   may_arise   --   that   tangible_object   body   depending   body-contact   arisen   or   arises   or   will_arise   or   may_arise   --   that   tangible_object   body   depending   born_of_body-contact   --   --   --   body-consciousness   arisen   or   arises   or   will_arise   or   may_arise   or   tangible   this   tangible-base   this   tangible_element   this   this   that   materiality   tangible-base
...
\glb    What   that   materiality   water_element   That   water   watery   cohesion   cohesive   binding   of   this   that   materiality   water_element   this   that   materiality   not   clung_to
\ex     What is that materiality, the water element? That which is water, watery, cohesion, cohesive, the binding quality of materiality—this is that materiality, the water element. This is that materiality not clung to.
```
...
\glb    What   that   materiality   not_clung_to   sound-base   bodily_intimation   vocal_intimation   of   lightness   of   malleability   of   wieldiness   of   decay   of   impermanence   that   or   other   is   materiality   not   kamma   produced   visible_object_base   smell-base   taste-base   tangible-base   space_element   water_element   of   growth   of   continuity   nutriment   nutriment   this   that   materiality   not_clung_to
...
\glb    What   that   matter   grasped   --   body-base   femininity_faculty   masculinity_faculty   life_faculty   that   or   other   is   matter   kamma   due_to_kamma   visible-form-base   smell-base   taste-base   tangible-base   space_element   water_element   of   production   of   continuity   edible   food   this   that   matter   grasped
...
\glb    What   that   matter   visible   visible-form-base   this   that   matter   visible
\ex     What is that matter which is visible? The visible form base—this is that matter which is visible.
```
...
\glb    What   that   matter   invisible   --   edible   food   this   that   matter   invisible
\ex     What is that matter which is invisible? The eye base...pe...edible food—this is that matter which is invisible.
```
...
\glb    What   that   matter   with_impingement   eye-base   ear-base   nose-base   tongue-base   body-base   visible-form-base   sound-base   smell-base   taste-base   tangible-base   this   that   matter   with_impingement
\ex     What is that matter with impingement? The eye base, ear base, nose base, tongue base, body base, visible form base, sound base, smell base, taste base, tangible base—this is that matter with impingement.
```
...
\glb    What   that   matter   without_impingement   --   edible   food   this   that   matter   without_impingement
\ex     What is that matter without impingement? The femininity faculty...pe...edible food—this is that matter without impingement.
```
...
\glb    What   that   matter   faculty   eye-faculty   ear-faculty   nose-faculty   tongue-faculty   body-faculty   femininity_faculty   masculinity_faculty   life_faculty   this   that   matter   faculty
\ex     What is that matter which is a faculty? The eye faculty, ear faculty, nose faculty, tongue faculty, body faculty, femininity faculty, masculinity faculty, life faculty—this is that matter which is a faculty.
```
...
\glb    What   that   matter   not   faculty   --   edible   food   this   that   matter   not   faculty
\ex     What is that matter which is not a faculty? The visible form base...pe...edible food—this is that matter which is not a faculty.
```
...
\glb    What   that   matter   great_element   tangible-base   water_element   this   that   matter   great_element
\ex     What is that matter which is a great element? The tangible base and the water element—this is that matter which is a great element.
```
...
\glb    What   that   matter   not   great_element   --   edible   food   this   that   matter   not   great_element
\ex     What is that matter which is not a great element? The eye base...pe...edible food—this is that matter which is not a great element.
```
...
\glb    What   that   material   following   bodily_intimation   vocal_intimation   this   that   material   following
\ex     What is that material form which is following the mind? Bodily intimation, vocal intimation—this is that material form which is following the mind.
```
...
\glb    What   that   material   not   following   --   edible   food   this   that   material   not   following
\ex     What is that material form which is not following the mind? The eye-base...edible food—this is that material form which is not following the mind.
```
...
\glb    What   that   material   internal   --   body-base   this   that   material   internal
\ex     What is that material form which is internal? The eye-base...body-base—this is that material form which is internal.
```
...
\glb    What   that   material   external   --   edible   food   this   that   material   external
\ex     What is that material form which is external? Visible form...edible food—this is that material form which is external.
```
...
\glb    What   that   material   gross   --   tangible-base   this   that   material   gross
\ex     What is that gross material form? The eye-base... and so on... the tangible-base—this is that gross material form.
```
...
\glb    What   that   material   near   --   tangible-base   this   that   material   near
\ex     What is that near material form? The eye-base... and so on... the tangible-base—this is that near material form.
```
...
\glb    What   that   material   born_of_bodily_contact   --   --   --   body-consciousness   basis   body-base   this   that   material   body-consciousness   basis
...
\glb    What   that   material   visual_contact   object   visible_form   this   that   material   visual_contact   object
...
\glb    What   that   material   visual_contact   not   object   --   edible   food   this   that   material   visual_contact   not   object
...
\glb    What   that   material   --   --   --   --   bodily_contact   object   tangible-base   this   that   material   bodily_contact   object
...
\glb    What   that   material   bodily_contact   not   object   --   edible   food   this   that   material   bodily_contact   not   object
...
\glb    What   that   material   born_of_bodily_contact   --   --   --   body-consciousness   object   tangible-base   this   that   material   body-consciousness   object
...
\glb    What   that   matter   eye-base   That   eye   four   great_primaries   derived   --   empty   village   this   this   that   matter   eye-base
\ex     What is that material form which is the eye sense base? That eye, which is sensitive matter derived from the four great primaries… like an empty village—this is that material form which is the eye sense base.
```
...
\glb    What   that   material   not   eye-base   --   edible   food   this   that   material   not   eye-base
\ex     What is that material form which is not the eye sense base? The ear sense base… and edible food—this is that material form which is not the eye sense base.
```
...
\glb    What   that   material   not   body-base   --   edible   food   this   that   material   not   body-base
\ex     What is that material form which is not the body sense base? The eye sense base… and edible food—this is that material form which is not the body sense base.
```
...
\glb    What   that   material   visible-form-base   That   material   four   great_primaries   derived   --   visible_form_element   this   this   that   material   visible-form-base
\ex     What is that material form which is the visible form sense base? That visible form, which is color and appearance derived from the four great primaries… visible form element—this is that material form which is the visible form sense base.
```
...
\glb    What   that   material   not   visible-form-base   --   edible   food   this   that   material   not   visible-form-base
\ex     What is that material form which is not the visible form sense base? The eye sense base… and edible food—this is that material form which is not the visible form sense base.
```
...
\glb    What   that   material   --   smell-base   --   --   tangible-base   --   tangible_element   this   this   that   material   tangible-base
\ex     What is that material form which is the sound sense base… the smell sense base… the taste sense base… the tangible sense base? The earth element… tangible element—this is that material form which is the tangible sense base.
```
...
\glb    What   that   material   not   tangible-base   --   edible   food   this   that   material   not   tangible-base
\ex     What is that material form which is not the tangible sense base? The eye sense base… and edible food—this is that material form which is not the tangible sense base.
```
...
\glb    What   that   material   eye_element   eye-base   this   that   material   eye_element
\ex     What is that material form which is the eye element? The eye sense base—this is that material form which is the eye element.
```
...
\glb    What   that   material   not   eye_element   --   edible   food   this   that   material   not   eye_element
\ex     What is that material form which is not the eye element? The ear sense base… and edible food—this is that material form which is not the eye element.
```
...
\glb    What   that   material   --   --   --   body-element   body-base   this   that   material   body-element
\ex     What is that material form which is the ear-element the nose-element the tongue-element the body-element? The body-base—this material form is the body-element.
```
...
\glb    What   that   material   not   body-element   --   edible   food   this   that   material   not   body-element
\ex     What is that material form which is not the body-element? The eye-base and edible food—this material form is not the body-element.
```
...
\glb    What   that   material   visible-form-element   visible-form-base   this   that   material   visible-form-element
\ex     What is that material form which is the visible-form-element? The visible-form-base—this material form is the visible-form-element.
```
...
\glb    What   that   material   not   visible-form-element   --   edible   food   this   that   material   not   visible-form-element
\ex     What is that material form which is not the visible-form-element? The eye-base and edible food—this material form is not the visible-form-element.
```
...
\glb    What   that   material   --   --   --   tangible-element   tangible-base   this   that   material   tangible-element
\ex     What is that material form which is the sound-element the smell-element the taste-element the tangible-element? The tangible-base—this material form is the tangible-element.
```
...
\glb    What   that   material   not   tangible-element   --   edible   food   this   that   material   not   tangible-element
\ex     What is that material form which is not the tangible-element? The eye-base and edible food—this material form is not the tangible-element.
```
...
\glb    What   that   matter   eye-faculty   That   eye   four   great_primaries   derived   --   empty   village   this   this   that   matter   eye-faculty
\ex     What is that material form which is the eye-faculty? That eye, which is the sensitive matter derived from the four great primaries like an empty village—this material form is the eye-faculty.
```
...
\glb    What   that   material   not   eye-faculty   --   edible   food   this   that   material   not   eye-faculty
\ex     What is that material form which is not the eye-faculty? The ear-base and edible food—this material form is not the eye-faculty.
```
...
\glb    What   that   material   not   body-faculty   --   edible   food   this   that   material   not   body-faculty
\ex     What is that material form which is not the body-faculty? The eye-base and edible food—this material form is not the body-faculty.
```
...
```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   itthindriyaṃ   Yaṃ   itthiyā   itthiliṅgaṃ   itthinimittaṃ   itthikuttaṃ   itthākappo   itthattaṃ   itthibhāvo   idaṃ   taṃ   rūpaṃ   itthindriyaṃ
\glb    What   that   material   female-faculty   That   female   female_sign   female_mark   female_characteristic   female_appearance   femaleness   femaleness   this   that   material   female-faculty
\ex     What is that material phenomenon, the female faculty? That which is a woman's female sign, female mark, female characteristic, female appearance, femaleness, female state—this is that material phenomenon, the female faculty.
```
...
\glb    What   that   material   not   female-faculty   --   edible   food   this   that   material   not   female-faculty
\ex     What is that material phenomenon which is not the female faculty? The eye-base...pe...edible food—this is that material phenomenon which is not the female faculty.
```
...
```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   purisindriyaṃ   Yaṃ   purisassa   purisaliṅgaṃ   purisanimittaṃ   purisakuttaṃ   purisākappo   purisattaṃ   purisabhāvo   idaṃ   taṃ   rūpaṃ   purisindriyaṃ
\glb    What   that   material   male-faculty   That   male   male_sign   male_mark   male_characteristic   male_appearance   maleness   maleness   this   that   material   male-faculty
\ex     What is that material phenomenon, the male faculty? That which is a man's male sign, male mark, male characteristic, male appearance, maleness, male state—this is that material phenomenon, the male faculty.
```
...
\glb    What   that   material   not   male-faculty   --   edible   food   this   that   material   not   male-faculty
\ex     What is that material phenomenon which is not the male faculty? The eye-base...pe...edible food—this is that material phenomenon which is not the male faculty.
```
...
```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   jīvitindriyaṃ   Yo   tesaṃ   rūpīnaṃ   dhammānaṃ   āyu   ṭhiti   yapanā   yāpanā   iriyanā   vattanā   pālanā   jīvitaṃ   jīvitindriyaṃ   idaṃ   taṃ   rūpaṃ   jīvitindriyaṃ
\glb    What   that   material   life_faculty   That   those   material   phenomena   life   duration   maintenance   sustenance   carrying_on   continuance   preservation   life   life_faculty   this   that   material   life_faculty
\ex     What is that material phenomenon, the life faculty? That which is the life, duration, maintenance, sustenance, carrying on, continuance, preservation, life, life faculty of those material phenomena—this is that material phenomenon, the life faculty.
```
...
\glb    What   that   material   not   life_faculty   --   edible   food   this   that   material   not   life_faculty
\ex     What is that material phenomenon which is not the life faculty? The eye-base...pe...edible food—this is that material phenomenon which is not the life faculty.
```
...
```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   kāyaviññatti   Yā   kusalacittassa   vā   akusalacittassa   vā   abyākatacittassa   vā   abhikkamantassa   vā   paṭikkamantassa   vā   ālokentassa   vā   vilokentassa   vā   samiñjentassa   vā   pasārentassa   vā   kāyassa   thambhanā   santhambhanā   santhambhitattaṃ   viññatti   viññāpanā   viññāpitattaṃ   idaṃ   taṃ   rūpaṃ   kāyaviññatti
\glb    What   that   material   bodily_intimation   That   wholesome_mind   or   unwholesome_mind   or   indeterminate_mind   or   advancing   or   retreating   or   looking   or   looking_around   or   bending   or   stretching   or   body   stiffening   stiffening   stiffening   intimation   making   making_known   this   that   material   bodily_intimation
...
\glb    What   that   material   not   bodily_intimation   --   edible   food   this   that   material   not   bodily_intimation
\ex     What is that material phenomenon which is not bodily intimation? The eye-base...pe...edible food—this is that material phenomenon which is not bodily intimation.
```
...
```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   vacīviññatti   Yā   kusalacittassa   vā   akusalacittassa   vā   abyākatacittassa   vā   vācā   girā   byappatho   udīraṇaṃ   ghoso   ghosakammaṃ   vācā   vacībhedo   ayaṃ   vuccati   vācā   Yā   tāya   vācāya   viññatti   viññāpanā   viññāpitattaṃ   idaṃ   taṃ   rūpaṃ   vacīviññatti
\glb    What   that   material   vocal_intimation   That   wholesome_mind   or   unwholesome_mind   or   indeterminate_mind   or   speech   speech   utterance   utterance   sound   act_of_sounding   speech   differentiation_of_speech   this   called   speech   That   of   speech   intimation   utterance   speech   this   that   material   vocal_intimation
...
\glb    What   that   material   not   vocal_intimation   --   edible   food   this   that   material   not   vocal_intimation
\ex     What is that material phenomenon which is not vocal intimation? The eye-base...pe...edible food—this is that material phenomenon which is not vocal intimation.
```
...
```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   ākāsadhātu   Yo   ākāso   ākāsagataṃ   aghaṃ   aghagataṃ   vivaro   vivaragataṃ   asamphuṭṭhaṃ   catūhi   mahābhūtehi   idaṃ   taṃ   rūpaṃ   ākāsadhātu
\glb    What   that   matter   space_element   That   space   spatial   gap   characterized_by_gap   opening   characterized_by_opening   uncontacted   four   great_elements   this   that   matter   space_element
\ex     What is that matter, the space element? That space, spatial, gap, characterized by gap, opening, characterized by opening, uncontacted by the four great elements – this is that matter, the space element.
```
...
\glb    What   that   matter   not   space_element   eye-base   --   edible   food   this   that   matter   not   space_element
\ex     What is that matter which is not the space element? The eye-base… up to edible food – this is that matter which is not the space element.
```
...
\glb    What   that   matter   water_element   That   water   watery   cohesion   cohesion   binding   of   this   that   matter   water_element
\ex     What is that matter, the water element? That water, watery, cohesion, characterized by cohesion, the binding nature of matter – this is that matter, the water element.
```
...
\glb    What   that   matter   not   water_element   --   edible   food   this   that   matter   not   water_element
\ex     What is that matter which is not the water element? The eye-base… up to edible food – this is that matter which is not the water element.
```
...
```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   rūpassa   lahutā   Yā   rūpassa   lahutā   lahupariṇāmatā   adandhanatā   avitthanatā   idaṃ   taṃ   rūpaṃ   rūpassa   lahutā
\glb    What   that   matter   of   lightness   That   of   lightness   changeability   non-sluggishness   --   this   that   matter   of   lightness
\ex     What is that matter, the lightness of matter? That lightness of matter, quick changeability, non-sluggishness, non-expansiveness – this is that matter, the lightness of matter.
```

## ^1-729

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   rūpassa   na   lahutā   Cakkhāyatanaṃ…pe…   kabaḷīkāro   āhāro   idaṃ   taṃ   rūpaṃ   rūpassa   na   lahutā
\glb    What   that   matter   of   not   lightness   --   edible   food   this   that   matter   of   not   lightness
\ex     What is that matter which is not the lightness of matter? The eye-base… up to edible food – this is that matter which is not the lightness of matter.
```
...
```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   rūpassa   mudutā   Yā   rūpassa   mudutā   maddavatā   akakkhaḷatā   akathinatā   idaṃ   taṃ   rūpaṃ   rūpassa   mudutā
\glb    What   that   matter   of   malleability   That   of   malleability   softness   non-harshness   softness   this   that   matter   of   malleability
\ex     What is that matter, the malleability of matter? That malleability of matter, softness, non-harshness, non-stiffness – this is that matter, the malleability of matter.
```

## ^1-731

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   rūpassa   na   mudutā   Cakkhāyatanaṃ…pe…   kabaḷīkāro   āhāro   idaṃ   taṃ   rūpaṃ   rūpassa   na   mudutā
\glb    What   that   matter   of   not   malleability   --   edible   food   this   that   matter   of   not   malleability
\ex     What is that matter which is not the malleability of matter? The eye-base… up to edible food – this is that matter which is not the malleability of matter.
```
...
```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   rūpassa   kammaññatā   Yā   rūpassa   kammaññatā   kammaññattaṃ   kammaññabhāvo   idaṃ   taṃ   rūpaṃ   rūpassa   kammaññatā
\glb    What   that   matter   of   workability   That   of   workability   suitability   suitability   this   that   matter   of   workability
\ex     What is that matter, the workability of matter? That workability of matter, suitability for action, state of being workable – this is that matter, the workability of matter.
```
...
\glb    What   that   matter   of   not   workability   --   edible   food   this   that   matter   of   not   workability
\ex     What is that matter which is not the workability of matter? The eye-base… up to edible food – this is that matter which is not the workability of matter.
```
...
```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   rūpassa   upacayo   Yo   āyatanānaṃ   ācayo   so   rūpassa   upacayo   idaṃ   taṃ   rūpaṃ   rūpassa   upacayo
\glb    What   that   matter   of   growth   That   bases   accumulation   that   of   growth   this   that   matter   of   growth
\ex     What is the growth of matter? That which is the accumulation of the bases is the growth of matter. This is the growth of matter.
```
...
\gla    Katamaṃ   taṃ   rūpaṃ   rūpassa   santati   Yo   rūpassa   upacayo   sā   rūpassa   santati   idaṃ   taṃ   rūpaṃ   rūpassa   santati
\glb    What   that   matter   of   continuity   That   of   growth   that   of   continuity   this   that   matter   of   continuity
\ex     What is the continuity of matter? That which is the growth of matter is the continuity of matter. This is the continuity of matter.
```
...
```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   rūpassa   jaratā   Yā   rūpassa   jarā   jīraṇatā   khaṇḍiccaṃ   pāliccaṃ   valittacatā   āyuno   saṃhāni   indriyānaṃ   paripāko   idaṃ   taṃ   rūpaṃ   rūpassa   jaratā
\glb    What   that   matter   of   decay   That   of   decay   decay   breaking_up   --   wrinkling   --   decline   faculties   ripening   this   that   matter   of   decay
\ex     What is the aging of matter? That which is the decay of matter, its wearing out, breaking up, greying, wrinkling, decline of life-span, and ripening of the faculties—this is the aging of matter.
```
...
```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   rūpassa   aniccatā   Yo   rūpassa   khayo   vayo   bhedo   paribhedo   aniccatā   antaradhānaṃ   idaṃ   taṃ   rūpaṃ   rūpassa   aniccatā
\glb    What   that   matter   of   impermanence   That   of   --   --   breaking_up   complete_breaking_up   impermanence   disappearance   this   that   matter   of   impermanence
\ex     What is the impermanence of matter? That which is the wearing away of matter, its dissolution, breaking up, complete breaking up, impermanence, and disappearance—this is the impermanence of matter.
```
...
\glb    What   this   matter   edible   food   Rice   gruel   flour   fish   meat   milk   curd   ghee   fresh_butter   oil   honey   molasses   which   or   other   is   matter   which   which   country   beings   beings   beings   swallowed   teeth   throat   stomach   which   nutrient_essence   beings   subsist   this   this   matter   edible   food
...
```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   ajjhattikaṃ   upādā   Cakkhāyatanaṃ…pe…   kāyāyatanaṃ   idaṃ   taṃ   rūpaṃ   ajjhattikaṃ   upādā
\glb    What   that   matter   internal   derived   --   body-base   this   that   matter   internal   derived
\ex     What is that matter which is internal and derived? The eye base...pe...the body base. This is that matter which is internal and derived.
```
...
\glb    What   that   matter   external   derived   --   edible   food   this   that   matter   external   derived
\ex     What is that matter which is external and derived? The visible form base...pe...edible food. This is that matter which is external and derived.
```

## ^1-746

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   bāhiraṃ   no   upādā   Phoṭṭhabbāyatanaṃ   āpodhātu   idaṃ   taṃ   rūpaṃ   bāhiraṃ   no   upādā
\glb    What   that   matter   external   not   derived   tangible-base   water_element   this   that   matter   external   not   derived
\ex     What is that matter which is external and not derived? The tangible object base and the water element. This is that matter which is external and not derived.
```

## ^1-747

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   ajjhattikaṃ   upādiṇṇaṃ   Cakkhāyatanaṃ…pe…   kāyāyatanaṃ   idaṃ   taṃ   rūpaṃ   ajjhattikaṃ   upādiṇṇaṃ
\glb    What   that   matter   internal   grasped   --   body-base   this   that   matter   internal   grasped
\ex     What is that matter which is internal and grasped? The eye base...pe...the body base. This is that matter which is internal and grasped.
```
...
```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   ajjhattikaṃ   upādiṇṇupādāniyaṃ   Cakkhāyatanaṃ…pe…   kāyāyatanaṃ   idaṃ   taṃ   rūpaṃ   ajjhattikaṃ   upādiṇṇupādāniyaṃ
\glb    What   that   matter   internal   grasped   --   body-base   this   that   matter   internal   grasped
\ex     What is that matter which is internal, grasped, and graspable? The eye base...pe...the body base. This is that matter which is internal, grasped, and graspable.
```
...
\glb    What   that   matter   external   clung-to   femininity_faculty   masculinity_faculty   life_faculty   that   --   other   is   matter   kamma   produced   visible_form   smell   taste   tangible   space_element   water_element   of   growth   of   continuity   edible   food   this   that   matter   external   clung-to
...
```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   ajjhattikaṃ   anidassanaṃ   Cakkhāyatanaṃ…pe…   kāyāyatanaṃ   idaṃ   taṃ   rūpaṃ   ajjhattikaṃ   anidassanaṃ
\glb    What   that   matter   internal   not_visible   --   --   this   that   matter   internal   not_visible
\ex     What is that matter which is internal and not visible? The five sense bases—this is that matter which is internal and not visible.
```
...
\glb    What   that   matter   external   visible   visible_form   this   that   matter   external   visible
\ex     What is that matter which is external and visible? The visible form sphere—this is that matter which is external and visible.
```
...
\glb    What   that   matter   external   not_visible   sound   --   edible   food   this   that   matter   external   not_visible
...
```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   ajjhattikaṃ   sappaṭighaṃ   Cakkhāyatanaṃ…pe…   kāyāyatanaṃ   idaṃ   taṃ   rūpaṃ   ajjhattikaṃ   sappaṭighaṃ
\glb    What   that   matter   internal   with_impingement   --   --   this   that   matter   internal   with_impingement
\ex     What is that matter which is internal and with impingement? The five sense bases—this is that matter which is internal and with impingement.
```
...
\glb    What   that   matter   external   with_impingement   --   --   this   that   matter   external   with_impingement
\ex     What is that matter which is external and with impingement? The five sense objects—this is that matter which is external and with impingement.
```

## ^1-758

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   bāhiraṃ   appaṭighaṃ   Itthindriyaṃ…pe…   kabaḷīkāro   āhāro   idaṃ   taṃ   rūpaṃ   bāhiraṃ   appaṭighaṃ
\glb    What   that   matter   external   without_impingement   --   edible   food   this   that   matter   external   without_impingement
\ex     What is that matter which is external and without impingement? The femininity faculty... and edible food—this is that matter which is external and without impingement.
```

## ^1-759

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   ajjhattikaṃ   indriyaṃ   Cakkhundriyaṃ…pe…   kāyindriyaṃ   idaṃ   taṃ   rūpaṃ   ajjhattikaṃ   indriyaṃ
\glb    What   that   matter   internal   faculty   --   --   this   that   matter   internal   faculty
\ex     What is that matter which is internal and a faculty? The five sense faculties—this is that matter which is internal and a faculty.
```
...
\glb    What   that   matter   external   faculty   femininity_faculty   masculinity_faculty   life_faculty   this   that   matter   external   faculty
\ex     What is that matter which is external and a faculty? The femininity faculty, the masculinity faculty, and the life faculty—this is that matter which is external and a faculty.
```

## ^1-761

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   bāhiraṃ   na   indriyaṃ   Rūpāyatanaṃ…pe…   kabaḷīkāro   āhāro   idaṃ   taṃ   rūpaṃ   bāhiraṃ   na   indriyaṃ
\glb    What   that   form   external   not   faculty   --   edible   food   this   that   form   external   not   faculty
\ex     What is that rūpa, external, not a faculty? Visible form sense base…pe… edible food – This is that rūpa, external, not a faculty.
```

## ^1-762

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   ajjhattikaṃ   na   mahābhūtaṃ   Cakkhāyatanaṃ…pe…   kāyāyatanaṃ   idaṃ   taṃ   rūpaṃ   ajjhattikaṃ   na   mahābhūtaṃ
\glb    What   that   rūpa   internal   not   great_element   --   body-base   this   that   rūpa   internal   not   great_element
\ex     What is that rūpa, internal, not a great element? Eye sense base…pe… body sense base – This is that rūpa, internal, not a great element.
```
...
\glb    What   that   rūpa   external   great_element   tangible-base   water_element   this   that   rūpa   external   great_element
\ex     What is that rūpa, external, a great element? Tangible sense base, water element – This is that rūpa, external, a great element.
```

## ^1-764

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   bāhiraṃ   na   mahābhūtaṃ   Rūpāyatanaṃ…pe…   kabaḷīkāro   āhāro   idaṃ   taṃ   rūpaṃ   bāhiraṃ   na   mahābhūtaṃ
\glb    What   that   form   external   not   great_element   --   edible   food   this   that   form   external   not   great_element
\ex     What is that rūpa, external, not a great element? Visible form sense base…pe… edible food – This is that rūpa, external, not a great element.
```

## ^1-765

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   ajjhattikaṃ   na   viññatti   Cakkhāyatanaṃ…pe…   kāyāyatanaṃ   idaṃ   taṃ   rūpaṃ   ajjhattikaṃ   na   viññatti
\glb    What   that   rūpa   internal   not   communication   --   body-base   this   that   rūpa   internal   not   communication
\ex     What is that rūpa, internal, not communication? Eye sense base…pe… body sense base – This is that rūpa, internal, not communication.
```
...
\glb    What   that   rūpa   external   intimation   bodily_intimation   vocal_intimation   this   that   rūpa   external   intimation
...
```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   bāhiraṃ   na   viññatti   Rūpāyatanaṃ…pe…   kabaḷīkāro   āhāro   idaṃ   taṃ   rūpaṃ   bāhiraṃ   na   viññatti
\glb    What   that   form   external   not   communication   --   edible   food   this   that   form   external   not   communication
\ex     What is that rūpa, external, not communication? Visible form sense base…pe… edible food – This is that rūpa, external, not communication.
```
...
\glb    What   that   rūpa   internal   not   mind-originated   --   body-base   this   that   rūpa   internal   not   mind-originated
...
\glb    What   this   materiality   internal   not   following   --   body-base   this   this   materiality   internal   not   following
...
\glb    What   this   materiality   external   following   bodily_intimation   vocal_intimation   this   this   materiality   external   following
...
\glb    What   this   materiality   external   not   following   --   edible   food   this   this   materiality   external   not   following
...
```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   bāhiraṃ   santike   Rūpāyatanaṃ…pe…   phoṭṭhabbāyatanaṃ   idaṃ   taṃ   rūpaṃ   bāhiraṃ   santike
\glb    What   that   material   external   near   --   tangible-base   --   that   material   external   near
\ex     What is that material form which is external and near? Visible form base…pe…tangible object base.
```
...
```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   bāhiraṃ   na   cakkhāyatanaṃ   Rūpāyatanaṃ…pe…   kabaḷīkāro   āhāro   idaṃ   taṃ   rūpaṃ   bāhiraṃ   na   cakkhāyatanaṃ
\glb    What   that   matter   external   not   eye-base   --   edible   food   this   that   matter   external   not   eye-base
\ex     What is that external matter which is not the eye-base? The visible-base sound-base smell-base taste-base tangible-base edible food. This is that external matter which is not the eye-base.
```
...
\glb    What   that   matter   internal   eye-base   That   eye   four   great_primaries   derived   --   empty   village   this   this   that   matter   internal   eye-base
\ex     What is that internal matter which is the eye-base? That eye, which is the sensitive matter derived from the four great primaries (like) an empty village, a messenger. This is that internal matter which is the eye-base.
```

## ^1-809

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   ajjhattikaṃ   na   cakkhāyatanaṃ   Sotāyatanaṃ…pe…   kāyāyatanaṃ   idaṃ   taṃ   rūpaṃ   ajjhattikaṃ   na   cakkhāyatanaṃ
\glb    What   that   matter   internal   not   eye-base   --   body-base   this   that   matter   internal   not   eye-base
\ex     What is that internal matter which is not the eye-base? The ear-base nose-base tongue-base body-base. This is that internal matter which is not the eye-base.
```
...
\glb    What   that   matter   external   not   --   not   --   not   --   not   body-base   --   edible   food   this   that   matter   external   not   body-base
\ex     What is that external matter which is not the ear-base not the nose-base not the tongue-base not the body-base? The visible-base sound-base smell-base taste-base tangible-base edible food. This is that external matter which is not the body-base.
```
...
\glb    What   that   matter   internal   not   --   --   --   this   that   matter   internal   not   --
\ex     What is that internal matter that is not the body sense-base? The eye sense-base...pe... the tongue sense-base - this is that internal matter that is not the body sense-base.
```

## ^1-813

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   ajjhattikaṃ   na   rūpāyatanaṃ   Cakkhāyatanaṃ…pe…   kāyāyatanaṃ   idaṃ   taṃ   rūpaṃ   ajjhattikaṃ   na   rūpāyatanaṃ
\glb    What   that   matter   internal   not   visible_form   --   --   this   that   matter   internal   not   visible_form
\ex     What is that internal matter that is not the visible form sense-base? The eye sense-base...pe... the body sense-base - this is that internal matter that is not the visible form sense-base.
```
...
\glb    What   that   matter   external   visible_form   That   matter   four   great_elements   derived   --   visible_form_element   this   this   that   matter   external   visible_form
\ex     What is that external visible form sense-base matter? That matter, derived from the four great elements, is color and appearance...pe... the visible form element - this is that external visible form sense-base matter.
```

## ^1-815

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   bāhiraṃ   na   rūpāyatanaṃ   Saddāyatanaṃ…pe…   kabaḷīkāro   āhāro   idaṃ   taṃ   rūpaṃ   bāhiraṃ   na   rūpāyatanaṃ
\glb    What   that   matter   external   not   visible_form   --   edible   food   this   that   matter   external   not   visible_form
\ex     What is that external matter that is not the visible form sense-base? The sound sense-base...pe... edible food - this is that external matter that is not the visible form sense-base.
```
...
```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   bāhiraṃ   na   cakkhudhātu   Rūpāyatanaṃ…pe…   kabaḷīkāro   āhāro   idaṃ   taṃ   rūpaṃ   bāhiraṃ   na   cakkhudhātu
\glb    What   that   matter   external   not   eye_element   --   edible   food   this   that   matter   external   not   eye_element
\ex     What is that external matter that is not the eye element? The visible form sense-base...pe... edible food - this is that external matter that is not the eye element.
```
...
\glb    What   that   matter   internal   eye_element   --   this   that   matter   internal   eye_element
\ex     What is that internal eye element matter? The eye sense-base - this is that internal eye element matter.
```

## ^1-821

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   ajjhattikaṃ   na   cakkhudhātu   Sotāyatanaṃ…pe…   kāyāyatanaṃ   idaṃ   taṃ   rūpaṃ   ajjhattikaṃ   na   cakkhudhātu
\glb    What   that   matter   internal   not   eye-element   --   body-base   this   that   matter   internal   not   eye-element
\ex     What is that internal matter that is not the eye-element? The ear-base...body-base – this is that internal matter that is not the eye-element.
```
...
\glb    What   that   matter   external   not   --   not   --   not   --   not   body-element   --   edible   food   this   that   matter   external   not   body-element
\ex     What is that external matter that is not the ear-element...not the body-element? The visible-form-base...edible food – this is that external matter that is not the body-element.
```
...
\glb    What   that   matter   internal   body-element   body-base   this   that   matter   internal   body-element
\ex     What is that internal matter that is the body-element? The body-base – this is that internal matter that is the body-element.
```

## ^1-824

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   ajjhattikaṃ   na   kāyadhātu   Cakkhāyatanaṃ…pe…   jivhāyatanaṃ   idaṃ   taṃ   rūpaṃ   ajjhattikaṃ   na   kāyadhātu
\glb    What   that   matter   internal   not   body-element   --   tongue-base   this   that   matter   internal   not   body-element
\ex     What is that internal matter that is not the body-element? The eye-base...tongue-base – this is that internal matter that is not the body-element.
```
...
\glb    What   that   matter   internal   not   visible-form-element   --   body-base   this   that   matter   internal   not   visible-form-element
\ex     What is that internal matter that is not the visible-form-element? The eye-base...body-base – this is that internal matter that is not the visible-form-element.
```
...
\glb    What   that   matter   external   visible-form-element   visible-form-base   this   that   matter   external   visible-form-element
\ex     What is that external matter that is the visible-form-element? The visible-form-base – this is that external matter that is the visible-form-element.
```

## ^1-827

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   bāhiraṃ   na   rūpadhātu   Saddāyatanaṃ…pe…   kabaḷīkāro   āhāro   idaṃ   taṃ   rūpaṃ   bāhiraṃ   na   rūpadhātu
\glb    What   that   matter   external   not   visible-form-element   --   edible   food   this   that   matter   external   not   visible-form-element
\ex     What is that external matter that is not the visible-form-element? The sound-base...edible food – this is that external matter that is not the visible-form-element.
```
...
\glb    What   that   matter   internal   not   --   not   --   not   --   --   not   tangible-element   --   body-base   this   that   matter   internal   not   tangible-element
\ex     What is that internal matter that is not the sound-element...not the tangible-element? The eye-base...body-base – this is that internal matter that is not the tangible-element.
```
...
\glb    What   that   matter   external   tangible-element   tangible-base   this   that   matter   external   tangible-element
\ex     What is that external matter that is the tangible-element? The tangible-base – this is that external matter that is the tangible-element.
```
...
\glb    What   that   matter   external   not   tangible-element   --   edible   food   this   that   matter   external   not   tangible-element
\ex     What is that external matter that is not the tangible-element? The visible-form-base...edible food – this is that external matter that is not the tangible-element.
```

## ^1-831

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   bāhiraṃ   na   cakkhundriyaṃ   Rūpāyatanaṃ…pe…   kabaḷīkāro   āhāro   idaṃ   taṃ   rūpaṃ   bāhiraṃ   na   cakkhundriyaṃ
\glb    What   that   material   external   not   eye-faculty   --   edible   food   this   that   material   external   not   eye-faculty
\ex     What is that material form which is external and not the eye-faculty? Visible form…pe… edible food – this is that material form which is external and not the eye-faculty.
```
...
\glb    What   that   matter   internal   eye-faculty   That   eye   four   great_primary_elements   derived   --   --   --   this   this   that   matter   internal   eye-faculty
\ex     What is that material form which is internal and is the eye-faculty? That eye, which is the sensitive matter derived from the four great primary elements…pe… – this is that material form which is internal and is the eye-faculty.
```

## ^1-833

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   ajjhattikaṃ   na   cakkhundriyaṃ   Sotāyatanaṃ…pe…   kāyāyatanaṃ   idaṃ   taṃ   rūpaṃ   ajjhattikaṃ   na   cakkhundriyaṃ
\glb    What   that   material   internal   not   eye-faculty   --   body-base   this   that   material   internal   not   eye-faculty
\ex     What is that material form which is internal and not the eye-faculty? The ear-base…pe… the body-base – this is that material form which is internal and not the eye-faculty.
```
...
\glb    What   that   material   external   not   --   not   --   not   --   not   body-faculty   --   edible   food   this   that   material   external   not   body-faculty
\ex     What is that material form which is external and not the ear-faculty…pe… not the nose-faculty…pe… not the tongue-faculty…pe… not the body-faculty? Visible form…pe… edible food – this is that material form which is external and not the body-faculty.
```
...
```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   ajjhattikaṃ   na   kāyindriyaṃ   Cakkhāyatanaṃ…pe…   jivhāyatanaṃ   idaṃ   taṃ   rūpaṃ   ajjhattikaṃ   na   kāyindriyaṃ
\glb    What   that   material   internal   not   body-faculty   --   tongue-base   this   that   material   internal   not   body-faculty
\ex     What is that material form which is internal and not the body-faculty? The eye-base…pe… the tongue-base – this is that material form which is internal and not the body-faculty.
```

## ^1-837

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   ajjhattikaṃ   na   itthindriyaṃ   Cakkhāyatanaṃ…pe…   kāyāyatanaṃ   idaṃ   taṃ   rūpaṃ   ajjhattikaṃ   na   itthindriyaṃ
\glb    What   that   material   internal   not   female-faculty   --   body-base   this   that   material   internal   not   female-faculty
\ex     What is that material form which is internal and not the female-faculty? The eye-base…pe… the body-base – this is that material form which is internal and not the female-faculty.
```
...
\glb    What   that   material   external   female-faculty   That   female   female_sign   --   female_characteristic   female_appearance   femaleness   femaleness   this   that   material   external   female-faculty
\ex     What is that material form which is external and is the female-faculty? That which is the woman's female characteristic, female sign, female form, female appearance, femaleness, female state – this is that material form which is external and is the female-faculty.
```

## ^1-839

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   bāhiraṃ   na   itthindriyaṃ   Rūpāyatanaṃ…pe…   kabaḷīkāro   āhāro   idaṃ   taṃ   rūpaṃ   bāhiraṃ   na   itthindriyaṃ
\glb    What   that   material   external   not   female-faculty   --   edible   food   this   that   material   external   not   female-faculty
\ex     What is that material form which is external and not the female-faculty? Visible form…pe… edible food – this is that material form which is external and not the female-faculty.
```

## ^1-840

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   ajjhattikaṃ   na   purisindriyaṃ   Cakkhāyatanaṃ…pe…   kāyāyatanaṃ   idaṃ   taṃ   rūpaṃ   ajjhattikaṃ   na   purisindriyaṃ
\glb    What   that   material   internal   not   male-faculty   --   body-base   this   that   material   internal   not   male-faculty
\ex     What is that material form which is internal and not the male-faculty? The eye-base…pe… the body-base – this is that material form which is internal and not the male-faculty.
```
...
\glb    What   that   material   external   masculinity_faculty   That   male   male_sign   --   male_characteristic   male_appearance   masculinity   masculinity   this   that   material   external   masculinity_faculty
\ex     What is that external material phenomenon which is the masculinity faculty? That which is a man's male characteristic, male sign, male feature, male appearance, masculinity, male nature – this is that external material phenomenon which is the masculinity faculty.
```

## ^1-842

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   bāhiraṃ   na   purisindriyaṃ   Rūpāyatanaṃ…pe…   kabaḷīkāro   āhāro   idaṃ   taṃ   rūpaṃ   bāhiraṃ   na   purisindriyaṃ
\glb    What   that   material   external   not   masculinity_faculty   --   edible   food   this   that   material   external   not   masculinity_faculty
\ex     What is that external material phenomenon which is not the masculinity faculty? Visible form… edible food – this is that external material phenomenon which is not the masculinity faculty.
```

## ^1-843

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   ajjhattikaṃ   na   jīvitindriyaṃ   Cakkhāyatanaṃ…pe…   kāyāyatanaṃ   idaṃ   taṃ   rūpaṃ   ajjhattikaṃ   na   jīvitindriyaṃ
\glb    What   that   material   internal   not   life_faculty   --   body-base   this   that   material   internal   not   life_faculty
\ex     What is that internal material phenomenon which is not the life faculty? The eye base… the body base – this is that internal material phenomenon which is not the life faculty.
```
...
\glb    What   that   material   external   life_faculty   That   those   material   phenomena   life   duration   maintenance   sustenance   activity   maintenance   preservation   life   life_faculty   this   that   material   external   life_faculty
\ex     What is that external material phenomenon which is the life faculty? That which is the life, duration, maintenance, sustenance, activity, functioning, preservation, and vitality of those material phenomena, the life faculty – this is that external material phenomenon which is the life faculty.
```

## ^1-845

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   bāhiraṃ   na   jīvitindriyaṃ   Rūpāyatanaṃ…pe…   kabaḷīkāro   āhāro   idaṃ   taṃ   rūpaṃ   bāhiraṃ   na   jīvitindriyaṃ
\glb    What   that   material   external   not   life_faculty   --   edible   food   this   that   material   external   not   life_faculty
\ex     What is that external material phenomenon which is not the life faculty? Visible form… edible food – this is that external material phenomenon which is not the life faculty.
```

## ^1-846

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   ajjhattikaṃ   na   kāyaviññatti   Cakkhāyatanaṃ…pe…   kāyāyatanaṃ   idaṃ   taṃ   rūpaṃ   ajjhattikaṃ   na   kāyaviññatti
\glb    What   that   material   internal   not   bodily_intimation   --   body-base   this   that   material   internal   not   bodily_intimation
\ex     What is that internal material phenomenon which is not bodily intimation? The eye base… the body base – this is that internal material phenomenon which is not bodily intimation.
```
...
\glb    What   that   material   external   bodily_intimation   That   wholesome   or   unwholesome   or   indeterminate   or   advancing   or   retreating   or   looking   or   --   or   bending   or   stretching   or   body   stiffening   stiffening   stiffening   intimation   making   making_known   this   that   material   external   bodily_intimation
...
```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   bāhiraṃ   na   kāyaviññatti   Rūpāyatanaṃ…pe…   kabaḷīkāro   āhāro   idaṃ   taṃ   rūpaṃ   bāhiraṃ   na   kāyaviññatti
\glb    What   that   material   external   not   bodily_intimation   --   edible   food   this   that   material   external   not   bodily_intimation
\ex     What is that external material phenomenon which is not bodily intimation? Visible form… edible food – this is that external material phenomenon which is not bodily intimation.
```

## ^1-849

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   ajjhattikaṃ   na   vacīviññatti   Cakkhāyatanaṃ…pe…   kāyāyatanaṃ   idaṃ   taṃ   rūpaṃ   ajjhattikaṃ   na   vacīviññatti
\glb    What   that   material   internal   not   verbal_intimation   --   body-base   this   that   material   internal   not   verbal_intimation
\ex     What is that internal material phenomenon which is not verbal intimation? The eye base… the body base – this is that internal material phenomenon which is not verbal intimation.
```
...
\glb    What   that   material   external   vocal_intimation   That   wholesome   or   unwholesome   or   indeterminate   or   speech   speech   utterance   utterance   --   --   speech   articulation   this   called   speech   That   of   speech   intimation   utterance   speech   this   that   material   external   vocal_intimation
...
```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   bāhiraṃ   na   vacīviññatti   Rūpāyatanaṃ…pe…   kabaḷīkāro   āhāro   idaṃ   taṃ   rūpaṃ   bāhiraṃ   na   vacīviññatti
\glb    What   that   matter   external   not   verbal_intimation   --   edible   food   this   that   matter   external   not   verbal_intimation
\ex     What is that external matter that is not verbal intimation? Visible form base...edible food. This is that external matter that is not verbal intimation.
```

## ^1-852

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   ajjhattikaṃ   na   ākāsadhātu   Cakkhāyatanaṃ…pe…   kāyāyatanaṃ   idaṃ   taṃ   rūpaṃ   ajjhattikaṃ   na   ākāsadhātu
\glb    What   that   matter   internal   not   space_element   --   body-base   this   that   matter   internal   not   space_element
\ex     What is that internal matter that is not the space element? Eye base...body base. This is that internal matter that is not the space element.
```

## ^1-853

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   bāhiraṃ   ākāsadhātu   Yo   ākāso   ākāsagataṃ   aghaṃ   aghagataṃ   vivaro   vivaragataṃ   asamphuṭṭhaṃ   catūhi   mahābhūtehi   idaṃ   taṃ   rūpaṃ   bāhiraṃ   ākāsadhātu
\glb    What   that   matter   external   space_element   That   space   --   --   aperture   aperture   aperture   --   four   great_elements   this   that   matter   external   space_element
\ex     What is that external matter which is the space element? That space, space-related, obstruction, obstruction-related, aperture, aperture-related, not touched by the four great elements. This is that external matter which is the space element.
```

## ^1-854

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   bāhiraṃ   na   ākāsadhātu   Rūpāyatanaṃ…pe…   kabaḷīkāro   āhāro   idaṃ   taṃ   rūpaṃ   bāhiraṃ   na   ākāsadhātu
\glb    What   that   matter   external   not   space_element   --   edible   food   this   that   matter   external   not   space_element
\ex     What is that external matter that is not the space element? Visible form base...edible food. This is that external matter that is not the space element.
```

## ^1-855

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   ajjhattikaṃ   na   āpodhātu   Cakkhāyatanaṃ…pe…   kāyāyatanaṃ   idaṃ   taṃ   rūpaṃ   ajjhattikaṃ   na   āpodhātu
\glb    What   that   matter   internal   not   water_element   --   body-base   this   that   matter   internal   not   water_element
\ex     What is that internal matter that is not the water element? Eye base...body base. This is that internal matter that is not the water element.
```

## ^1-856

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   bāhiraṃ   āpodhātu   Yaṃ   āpo   āpogataṃ   sineho   sinehagataṃ   bandhanattaṃ   rūpassa   idaṃ   taṃ   rūpaṃ   bāhiraṃ   āpodhātu
\glb    What   that   matter   external   water_element   That   water   --   cohesion   cohesion   binding   of   this   that   matter   external   water_element
\ex     What is that external matter which is the water element? That water, water-related, cohesion, cohesion-related, the binding nature of matter. This is that external matter which is the water element.
```

## ^1-857

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   bāhiraṃ   na   āpodhātu   Rūpāyatanaṃ…pe…   kabaḷīkāro   āhāro   idaṃ   taṃ   rūpaṃ   bāhiraṃ   na   āpodhātu
\glb    What   that   matter   external   not   water_element   --   edible   food   this   that   matter   external   not   water_element
\ex     What is that external matter that is not the water element? Visible form base...edible food. This is that external matter that is not the water element.
```

## ^1-858

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   ajjhattikaṃ   rūpassa   na   lahutā   Cakkhāyatanaṃ…pe…   kāyāyatanaṃ   idaṃ   taṃ   rūpaṃ   ajjhattikaṃ   rūpassa   na   lahutā
\glb    What   that   matter   internal   of   not   lightness   --   body-base   this   that   matter   internal   of   not   lightness
\ex     What is that internal matter that is not the lightness of matter? Eye base...body base. This is that internal matter that is not the lightness of matter.
```

## ^1-859

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   bāhiraṃ   rūpassa   lahutā   Yā   rūpassa   lahutā   lahupariṇāmatā   adandhanatā   avitthanatā   idaṃ   taṃ   rūpaṃ   bāhiraṃ   rūpassa   lahutā
\glb    What   that   matter   external   of   lightness   That   of   lightness   changeability   non-sluggishness   --   this   that   matter   external   of   lightness
\ex     What is that external matter which is the lightness of matter? That lightness of matter, quick changeability, non-sluggishness, non-unwieldiness. This is that external matter which is the lightness of matter.
```

## ^1-860

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   bāhiraṃ   rūpassa   na   lahutā   Rūpāyatanaṃ…pe…   kabaḷīkāro   āhāro   idaṃ   taṃ   rūpaṃ   bāhiraṃ   rūpassa   na   lahutā
\glb    What   that   matter   external   of   not   lightness   --   edible   food   this   that   matter   external   of   not   lightness
\ex     What is that external matter that is not the lightness of matter? Visible form base...edible food. This is that external matter that is not the lightness of matter.
```

## ^1-861

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   ajjhattikaṃ   rūpassa   na   mudutā   Cakkhāyatanaṃ…pe…   kāyāyatanaṃ   idaṃ   taṃ   rūpaṃ   ajjhattikaṃ   rūpassa   na   mudutā
\glb    What   that   matter   internal   of   not   pliability   --   body-base   this   that   matter   internal   of   not   pliability
\ex     What is that internal matter which is not pliability of matter? The eye-base... up to... the body-base – this is that internal matter which is not pliability of matter.
```

## ^1-862

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   bāhiraṃ   rūpassa   mudutā   Yā   rūpassa   mudutā   maddavatā   akakkhaḷatā   akathinatā   idaṃ   taṃ   rūpaṃ   bāhiraṃ   rūpassa   mudutā
\glb    What   that   matter   external   of   pliability   That   of   pliability   softness   non-harshness   softness   this   that   matter   external   of   pliability
\ex     What is that external matter which is pliability of matter? That pliability of matter which is softness, non-harshness, non-stiffness – this is that external matter which is pliability of matter.
```

## ^1-863

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   bāhiraṃ   rūpassa   na   mudutā   Rūpāyatanaṃ…pe…   kabaḷīkāro   āhāro   idaṃ   taṃ   rūpaṃ   bāhiraṃ   rūpassa   na   mudutā
\glb    What   that   matter   external   of   not   pliability   --   nutritive_essence   nutritive_essence   this   that   matter   external   of   not   pliability
\ex     What is that external matter which is not pliability of matter? The visible-form-base... up to... nutritive essence – this is that external matter which is not pliability of matter.
```

## ^1-864

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   ajjhattikaṃ   rūpassa   na   kammaññatā   Cakkhāyatanaṃ…pe…   kāyāyatanaṃ   idaṃ   taṃ   rūpaṃ   ajjhattikaṃ   rūpassa   na   kammaññatā
\glb    What   that   matter   internal   of   not   workability   --   body-base   this   that   matter   internal   of   not   workability
\ex     What is that internal matter which is not workability of matter? The eye-base... up to... the body-base – this is that internal matter which is not workability of matter.
```

## ^1-865

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   bāhiraṃ   rūpassa   kammaññatā   Yā   rūpassa   kammaññatā   kammaññattaṃ   kammaññabhāvo   idaṃ   taṃ   rūpaṃ   bāhiraṃ   rūpassa   kammaññatā
\glb    What   that   matter   external   of   workability   That   of   workability   workability   --   this   that   matter   external   of   workability
\ex     What is that external matter which is workability of matter? That workability of matter which is adaptability, fitness for action – this is that external matter which is workability of matter.
```

## ^1-866

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   bāhiraṃ   rūpassa   na   kammaññatā   Rūpāyatanaṃ…pe…   kabaḷīkāro   āhāro   idaṃ   taṃ   rūpaṃ   bāhiraṃ   rūpassa   na   kammaññatā
\glb    What   that   matter   external   of   not   workability   --   nutritive_essence   nutritive_essence   this   that   matter   external   of   not   workability
\ex     What is that external matter which is not workability of matter? The visible-form-base... up to... nutritive essence – this is that external matter which is not workability of matter.
```

## ^1-867

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   ajjhattikaṃ   rūpassa   na   upacayo   Cakkhāyatanaṃ…pe…   kāyāyatanaṃ   idaṃ   taṃ   rūpaṃ   ajjhattikaṃ   rūpassa   na   upacayo
\glb    What   that   matter   internal   of   not   growth   --   body-base   this   that   matter   internal   of   not   growth
\ex     What is that internal matter which is not growth of matter? The eye-base... up to... the body-base – this is that internal matter which is not growth of matter.
```

## ^1-868

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   bāhiraṃ   rūpassa   upacayo   Yo   āyatanānaṃ   ācayo   so   rūpassa   upacayo   idaṃ   taṃ   rūpaṃ   bāhiraṃ   rūpassa   upacayo
\glb    What   that   matter   external   of   growth   That   bases   accumulation   that   of   growth   this   that   matter   external   of   growth
\ex     What is that external matter which is growth of matter? That which is the accumulation of bases, that is the growth of matter – this is that external matter which is growth of matter.
```

## ^1-869

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   bāhiraṃ   rūpassa   na   upacayo   Rūpāyatanaṃ…pe…   kabaḷīkāro   āhāro   idaṃ   taṃ   rūpaṃ   bāhiraṃ   rūpassa   na   upacayo
\glb    What   that   matter   external   of   not   growth   --   nutritive_essence   nutritive_essence   this   that   matter   external   of   not   growth
\ex     What is that external matter which is not growth of matter? The visible-form-base... up to... nutritive essence – this is that external matter which is not growth of matter.
```

## ^1-870

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   ajjhattikaṃ   rūpassa   na   santati   Cakkhāyatanaṃ…pe…   kāyāyatanaṃ   idaṃ   taṃ   rūpaṃ   ajjhattikaṃ   rūpassa   na   santati
\glb    What   that   matter   internal   of   not   continuity   --   body-base   this   that   matter   internal   of   not   continuity
\ex     What is that internal matter which is not continuity of matter? The eye-base... up to... the body-base – this is that internal matter which is not continuity of matter.
```

## ^1-871

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   bāhiraṃ   rūpassa   santati   Yo   rūpassa   upacayo   sā   rūpassa   santati   idaṃ   taṃ   rūpaṃ   bāhiraṃ   rūpassa   santati
\glb    What   that   matter   external   of   continuity   That   of   production   that   of   continuity   this   that   matter   external   of   continuity
\ex     What is that external matter which is the continuity of matter? That which is the production of matter, that is the continuity of matter – this is that external matter which is the continuity of matter.
```

## ^1-872

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   bāhiraṃ   rūpassa   na   santati   Rūpāyatanaṃ…pe…   kabaḷīkāro   āhāro   idaṃ   taṃ   rūpaṃ   bāhiraṃ   rūpassa   na   santati
\glb    What   that   matter   external   of   not   continuity   --   edible   food   this   that   matter   external   of   not   continuity
\ex     What is that external matter which is not the continuity of matter? Visible form... edible food – this is that external matter which is not the continuity of matter.
```

## ^1-873

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   ajjhattikaṃ   rūpassa   na   jaratā   Cakkhāyatanaṃ…pe…   kāyāyatanaṃ   idaṃ   taṃ   rūpaṃ   ajjhattikaṃ   rūpassa   na   jaratā
\glb    What   that   matter   internal   of   not   aging   --   body-base   this   that   matter   internal   of   not   aging
\ex     What is that internal matter which is not the aging of matter? Eye-base... body-base – this is that internal matter which is not the aging of matter.
```

## ^1-874

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   bāhiraṃ   rūpassa   jaratā   Yā   rūpassa   jarā   jīraṇatā   khaṇḍiccaṃ   pāliccaṃ   valittacatā   āyuno   saṃhāni   indriyānaṃ   paripāko   idaṃ   taṃ   rūpaṃ   bāhiraṃ   rūpassa   jaratā
\glb    What   that   matter   external   of   decay   That   of   decay   decay   brokenness   --   wrinkling   life   decline   faculties   ripening   this   that   matter   external   of   decay
\ex     What is that external matter which is the aging of matter? That which is the decay of matter, its wearing out, brokenness, graying, wrinkling of skin, decline of life, ripening of faculties – this is that external matter which is the aging of matter.
```

## ^1-875

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   bāhiraṃ   rūpassa   na   jaratā   Rūpāyatanaṃ…pe…   kabaḷīkāro   āhāro   idaṃ   taṃ   rūpaṃ   bāhiraṃ   rūpassa   na   jaratā
\glb    What   that   matter   external   of   not   aging   --   edible   food   this   that   matter   external   of   not   aging
\ex     What is that external matter which is not the aging of matter? Visible form... edible food – this is that external matter which is not the aging of matter.
```

## ^1-876

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   ajjhattikaṃ   rūpassa   na   aniccatā   Cakkhāyatanaṃ…pe…   kāyāyatanaṃ   idaṃ   taṃ   rūpaṃ   ajjhattikaṃ   rūpassa   na   aniccatā
\glb    What   that   matter   internal   of   not   impermanence   --   body-base   this   that   matter   internal   of   not   impermanence
\ex     What is that internal matter which is not the impermanence of matter? Eye-base... body-base – this is that internal matter which is not the impermanence of matter.
```
...
\glb    What   that   matter   external   of   impermanence   That   of   --   --   breaking_up   complete_breaking_up   impermanence   disappearance   this   that   matter   external   of   impermanence
\ex     What is that external matter which is the impermanence of matter? That which is the wasting away of matter, its dissolution, breaking up, complete breaking up, impermanence, disappearance – this is that external matter which is the impermanence of matter.
```

## ^1-878

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   bāhiraṃ   rūpassa   na   aniccatā   Rūpāyatanaṃ…pe…   kabaḷīkāro   āhāro   idaṃ   taṃ   rūpaṃ   bāhiraṃ   rūpassa   na   aniccatā
\glb    What   that   matter   external   of   not   impermanence   --   edible   food   this   that   matter   external   of   not   impermanence
\ex     What is that external matter which is not the impermanence of matter? Visible form... edible food – this is that external matter which is not the impermanence of matter.
```

## ^1-879

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   ajjhattikaṃ   na   kabaḷīkāro   āhāro   Cakkhāyatanaṃ…pe…   kāyāyatanaṃ   idaṃ   taṃ   rūpaṃ   ajjhattikaṃ   na   kabaḷīkāro   āhāro
\glb    What   that   matter   internal   not   edible   food   --   body-base   this   that   matter   internal   not   edible   food
\ex     What is that internal matter which is not edible food? Eye-base... body-base – this is that internal matter which is not edible food.
```
...
\glb    What   that   matter   external   edible   food   Rice   gruel   flour   fish   meat   milk   curd   ghee   fresh_butter   oil   honey   --   that   or   other   is   matter   which   which   --   beings   beings   beings   swallowed   teeth   throat   stomach   which   nutrient_essence   beings   subsist   this   that   matter   external   edible   food
...
\glb    Which   that   matter   external   not   nutriment   nutriment   --   of   impermanence   this   that   matter   external   not   nutriment   nutriment   Thus   --   compendium   --
...
\glb    Which   that   matter   clinging   grasped   --   body-base   femininity_faculty   masculinity_faculty   life_faculty   that   or   other   is   matter   kamma   kamma-produced   visible-form-base   smell-base   taste-base   space_element   of   production   of   continuity   nutriment   nutriment   this   that   matter   clinging   grasped
...
\glb    Which   that   matter   clinging   not_grasped   sound-base   bodily_intimation   vocal_intimation   of   lightness   of   malleability   of   wieldiness   of   decay   of   impermanence   that   or   other   is   matter   not   kamma   kamma-produced   visible-form-base   smell-base   taste-base   space_element   of   production   of   continuity   nutriment   nutriment   this   that   matter   clinging   not_grasped
...
\glb    Which   that   matter   not   clinging   grasped   kamma   kamma-produced   tangible-base   water_element   this   that   matter   not   clinging   grasped
...
\glb    Which   that   matter   not   clinging   not_grasped   not   kamma   kamma-produced   tangible-base   water_element   this   that   matter   not   clinging   not_grasped
...
\glb    What   that   matter   not   derived   not_grasped   not   kamma   produced   tangible   water_element   this   that   matter   not   derived   not_grasped
...
```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   upādā   sappaṭighaṃ   Cakkhāyatanaṃ…pe…   rasāyatanaṃ   idaṃ   taṃ   rūpaṃ   upādā   sappaṭighaṃ
\glb    What   that   matter   derived   with_impingement   --   taste-base   this   that   matter   derived   with_impingement
\ex     What is that matter which is derived, with impingement? The eye-base... the taste-base – this is that matter which is derived, with impingement.
```

## ^1-891

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   upādā   appaṭighaṃ   Itthindriyaṃ…pe…   kabaḷīkāro   āhāro   idaṃ   taṃ   rūpaṃ   upādā   appaṭighaṃ
\glb    What   that   matter   derived   without_impingement   --   nutritive_essence   nutritive_essence   this   that   matter   derived   without_impingement
\ex     What is that matter which is derived, without impingement? The female faculty... nutritive essence – this is that matter which is derived, without impingement.
```
...
\glb    What   that   matter   not   derived   without_impingement   water_element   this   that   matter   not   derived   without_impingement
\ex     What is that matter which is not derived, without impingement? The water element – this is that matter which is not derived, without impingement.
```

## ^1-894

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   upādā   oḷārikaṃ   Cakkhāyatanaṃ…pe…   rasāyatanaṃ   idaṃ   taṃ   rūpaṃ   upādā   oḷārikaṃ
\glb    What   that   matter   derived   gross   --   taste-base   this   that   matter   derived   gross
\ex     What is that matter which is derived, gross? The eye-base... the taste-base – this is that matter which is derived, gross.
```

## ^1-895

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   upādā   sukhumaṃ   itthindriyaṃ…pe…   kabaḷīkāro   āhāro   idaṃ   taṃ   rūpaṃ   upādā   sukhumaṃ
\glb    What   that   matter   derived   subtle   --   nutritive_essence   nutritive_essence   this   that   matter   derived   subtle
\ex     What is that matter which is derived, subtle? The female faculty... nutritive essence – this is that matter which is derived, subtle.
```
...
\glb    What   that   matter   not   derived   subtle   water_element   this   that   matter   not   derived   subtle
\ex     What is that matter which is not derived, subtle? The water element – this is that matter which is not derived, subtle.
```
...
\glb    What   that   material   derived   far   --   nutritive_essence   nutritive_essence   this   that   material   derived   far
...
```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   upādā   santike   Cakkhāyatanaṃ…pe…   rasāyatanaṃ   idaṃ   taṃ   rūpaṃ   upādā   santike
\glb    What   that   material   derived   near   --   taste-base   this   that   material   derived   near
\ex     What is that material form derived and near? Eye-base...pe... taste-base. This is that material form derived and near.
```
...
\glb    What   that   material   grasped   visible   kamma   due_to_kamma   visible_form   this   that   material   grasped   visible
...
\glb    What   that   matter   grasped   invisible   --   body-base   femininity_faculty   masculinity_faculty   life_faculty   that   or   other   is   matter   kamma   due_to_kamma   smell-base   taste-base   tangible_object   space_element   water_element   of   growth   of   continuity   nutritive_essence   nutritive_essence   this   that   matter   grasped   invisible
...
\glb    What   that   material   not_grasped   visible   not   kamma   due_to_kamma   visible_form   this   that   material   not_grasped   visible
...
\glb    What   that   matter   not_grasped   invisible   sound-base   bodily_intimation   vocal_intimation   of   lightness   of   pliancy   of   wieldiness   of   aging   of   impermanence   that   or   other   is   matter   not   kamma   due_to_kamma   smell-base   taste-base   tangible_object   space_element   water_element   of   growth   of   continuity   nutritive_essence   nutritive_essence   this   that   matter   not_grasped   invisible
...
\glb    What   that   material   grasped   with_impingement   --   body-base   that   or   other   is   material   kamma   due_to_kamma   visible_form   smell-base   taste-base   tangible_object   this   that   material   grasped   with_impingement
...
\glb    What   that   matter   grasped   without_impingement   femininity_faculty   masculinity_faculty   life_faculty   that   or   other   is   matter   kamma   due_to_kamma   space_element   water_element   of   growth   of   continuity   nutritive_essence   nutritive_essence   this   that   matter   grasped   without_impingement
...
\glb    What   that   matter   grasped   with_impact   --   body-base   that   or   other   is   matter   kamma   produced   visible_form   smell   taste   tangible_object   this   that   matter   grasped   with_impact
...
\glb    What   that   matter   grasped   without_impact   female-faculty   male-faculty   life_faculty   that   or   other   is   matter   kamma   produced   space_element   water_element   of   production   of   continuity   edible   food   this   that   matter   grasped   without_impact
...
\glb    What   that   matter   not_grasped   impact   sound-base   that   or   other   is   matter   not   kamma   produced   visible-form-base   smell-base   taste-base   tangible-base   this   that   matter   not_grasped   impact
...
\glb    What   that   matter   not_grasped   no_impact   bodily_intimation   vocal_intimation   of   lightness   of   malleability   of   wieldiness   of   decay   of   impermanence   that   or   other   is   matter   not   kamma   produced   space_element   water_element   of   origination   of   continuity   edible   food   this   that   matter   not_grasped   no_impact
...
\glb    What   that   matter   grasped   primary_element   kamma   produced   tangible-base   water_element   this   that   matter   grasped   primary_element
...
\glb    What   that   matter   grasped   not   primary_element   --   body-base   femininity_faculty   masculinity_faculty   life_faculty   that   or   other   is   matter   kamma   produced   visible-form-base   smell-base   taste-base   space_element   of   origination   of   continuity   edible   food   this   that   matter   grasped   not   primary_element
...
\glb    What   that   matter   not_grasped   primary_element   not   kamma   produced   tangible-base   water_element   this   that   matter   not_grasped   primary_element
...
\glb    What   that   matter   not_grasped   not   primary_element   sound-base   bodily_intimation   vocal_intimation   of   lightness   of   malleability   of   wieldiness   of   decay   of   impermanence   that   or   other   is   matter   not   kamma   produced   visible-form-base   smell-base   taste-base   space_element   of   origination   of   continuity   edible   food   this   that   matter   not_grasped   not   primary_element
...
\glb    What   that   matter   grasped   subtle   femininity_faculty   masculinity_faculty   life_faculty   that   or   other   is   matter   kamma   produced   space_element   water_element   of   origination   of   continuity   edible   food   this   that   matter   grasped   subtle
...
\glb    What   that   matter   not_grasped   subtle   bodily_intimation   vocal_intimation   of   lightness   of   malleability   of   wieldiness   of   decay   of   impermanence   that   or   other   is   matter   not   kamma   produced   space_element   water_element   of   origination   of   continuity   edible   food   this   that   matter   not_grasped   subtle
...
\glb    What   that   matter   grasped   distant   femininity_faculty   masculinity_faculty   life_faculty   that   or   other   is   matter   kamma   due_to_kamma   space_element   water_element   of   production   of   continuity   edible   food   this   that   matter   grasped   distant
...
\glb    What   that   matter   grasped   near   --   body-base   that   or   other   is   matter   kamma   due_to_kamma   visible-form-base   smell-base   taste-base   tangible-base   this   that   matter   grasped   near
...
\glb    What   that   matter   ungrasped   distant   bodily_intimation   vocal_intimation   of   lightness   of   malleability   of   wieldiness   of   decay   of   impermanence   that   or   other   is   matter   not   kamma   due_to_kamma   space_element   water_element   of   production   of   continuity   edible   food   this   that   matter   ungrasped   distant
...
\glb    What   that   matter   ungrasped   near   sound-base   that   or   other   is   matter   not   kamma   due_to_kamma   visible-form-base   smell-base   taste-base   tangible-base   this   that   matter   ungrasped   near
...
```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   sappaṭighaṃ   indriyaṃ   Cakkhundriyaṃ…pe…   kāyindriyaṃ   idaṃ   taṃ   rūpaṃ   sappaṭighaṃ   indriyaṃ
\glb    What   that   matter   impinging   faculty   --   body-faculty   this   that   matter   impinging   faculty
\ex     What is that matter, impinging and a faculty? The eye faculty... to... the body faculty. This is that matter, impinging and a faculty.
```

## ^1-943

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   sappaṭighaṃ   na   indriyaṃ   Rūpāyatanaṃ…pe…   phoṭṭhabbāyatanaṃ   idaṃ   taṃ   rūpaṃ   sappaṭighaṃ   na   indriyaṃ
\glb    What   that   matter   impinging   not   faculty   --   tangible-base   this   that   matter   impinging   not   faculty
\ex     What is that matter, impinging and not a faculty? The visible form base... to... the tangible object base. This is that matter, impinging and not a faculty.
```

## ^1-944

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   appaṭighaṃ   indriyaṃ   Itthindriyaṃ   purisindriyaṃ   jīvitindriyaṃ   idaṃ   taṃ   rūpaṃ   appaṭighaṃ   indriyaṃ
\glb    What   that   matter   non-impinging   faculty   femininity_faculty   masculinity_faculty   life_faculty   this   that   matter   non-impinging   faculty
\ex     What is that matter, non-impinging and a faculty? The femininity faculty, masculinity faculty, life faculty. This is that matter, non-impinging and a faculty.
```
...
\glb    What   that   matter   non-impinging   not   faculty   bodily_intimation   --   edible   food   this   that   matter   non-impinging   not   faculty
\ex     What is that matter, non-impinging and not a faculty? Bodily intimation, vocal intimation... to... edible food. This is that matter, non-impinging and not a faculty.
```

## ^1-946

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   sappaṭighaṃ   mahābhūtaṃ   Phoṭṭhabbāyatanaṃ   idaṃ   taṃ   rūpaṃ   sappaṭighaṃ   mahābhūtaṃ
\glb    What   that   matter   impinging   great_essential_matter   tangible-base   this   that   matter   impinging   great_essential_matter
\ex     What is that matter, impinging and a great essential matter? The tangible object base. This is that matter, impinging and a great essential matter.
```

## ^1-947

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   sappaṭighaṃ   na   mahābhūtaṃ   Cakkhāyatanaṃ…pe…   rasāyatanaṃ   idaṃ   taṃ   rūpaṃ   sappaṭighaṃ   na   mahābhūtaṃ
\glb    What   that   matter   impinging   not   great_essential_matter   --   taste-base   this   that   matter   impinging   not   great_essential_matter
\ex     What is that matter, impinging and not a great essential matter? The eye base... to... the taste base. This is that matter, impinging and not a great essential matter.
```

## ^1-948

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   appaṭighaṃ   mahābhūtaṃ   Āpodhātu   idaṃ   taṃ   rūpaṃ   appaṭighaṃ   mahābhūtaṃ
\glb    What   that   material   non-impinging   primary_element   water_element   this   that   material   non-impinging   primary_element
\ex     What is that material phenomenon which is non-impinging and a primary element? The water element. This is that material phenomenon which is non-impinging and a primary element.
```
...
```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   indriyaṃ   oḷārikaṃ   Cakkhundriyaṃ…pe…   kāyindriyaṃ   idaṃ   taṃ   rūpaṃ   indriyaṃ   oḷārikaṃ
\glb    What   that   material   faculty   gross   --   body-faculty   this   that   material   faculty   gross
\ex     What is that material phenomenon which is a faculty and gross? The eye faculty…pe… the body faculty. This is that material phenomenon which is a faculty and gross.
```

## ^1-951

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   indriyaṃ   sukhumaṃ   Itthindriyaṃ   purisindriyaṃ   jīvitindriyaṃ   idaṃ   taṃ   rūpaṃ   indriyaṃ   sukhumaṃ
\glb    What   that   material   faculty   subtle   femininity_faculty   masculinity_faculty   life_faculty   this   that   material   faculty   subtle
\ex     What is that material phenomenon which is a faculty and subtle? The femininity faculty, the masculinity faculty, the life faculty. This is that material phenomenon which is a faculty and subtle.
```
...
```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   indriyaṃ   dūre   Itthindriyaṃ   purisindriyaṃ   jīvitindriyaṃ   idaṃ   taṃ   rūpaṃ   indriyaṃ   dūre
\glb    What   that   material   faculty   remote   femininity_faculty   masculinity_faculty   life_faculty   this   that   material   faculty   remote
\ex     What is that material phenomenon which is a faculty and remote? The femininity faculty, the masculinity faculty, the life faculty. This is that material phenomenon which is a faculty and remote.
```

## ^1-955

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   indriyaṃ   santike   Cakkhundriyaṃ…pe…   kāyindriyaṃ   idaṃ   taṃ   rūpaṃ   indriyaṃ   santike
\glb    What   that   material   faculty   proximate   --   body-faculty   this   that   material   faculty   proximate
\ex     What is that material phenomenon which is a faculty and proximate? The eye faculty…pe… the body faculty. This is that material phenomenon which is a faculty and proximate.
```
...
```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   mahābhūtaṃ   oḷārikaṃ   Phoṭṭhabbāyatanaṃ   idaṃ   taṃ   rūpaṃ   mahābhūtaṃ   oḷārikaṃ
\glb    What   that   matter   great_element   gross   tangible-base   this   that   matter   great_element   gross
\ex     What is that matter which is a great element and is gross? The tangible sense base. This is that matter which is a great element and is gross.
```

## ^1-959

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   mahābhūtaṃ   sukhumaṃ   Āpodhātu   idaṃ   taṃ   rūpaṃ   mahābhūtaṃ   sukhumaṃ
\glb    What   that   matter   great_element   subtle   water_element   this   that   matter   great_element   subtle
\ex     What is that matter which is a great element and is subtle? The water element. This is that matter which is a great element and is subtle.
```

## ^1-960

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   na   mahābhūtaṃ   oḷārikaṃ   Cakkhāyatanaṃ…pe…   rasāyatanaṃ   idaṃ   taṃ   rūpaṃ   na   mahābhūtaṃ   oḷārikaṃ
\glb    What   that   matter   not   great_element   gross   --   taste-base   this   that   matter   not   great_element   gross
\ex     What is that matter which is not a great element but is gross? The eye sense base... the taste sense base. This is that matter which is not a great element but is gross.
```
...
\glb    What   that   matter   not   great_element   subtle   --   nutritive_essence   nutritive_essence   this   that   matter   not   great_element   subtle
\ex     What is that matter which is not a great element and is subtle? The female faculty... nutritive essence. This is that matter which is not a great element and is subtle.
```
...
\glb    What   that   matter   great_element   remote   water_element   this   that   matter   great_element   remote
\ex     What is that matter which is a great element and is remote? The water element. This is that matter which is a great element and is remote.
```

## ^1-963

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   mahābhūtaṃ   santike   Phoṭṭhabbāyatanaṃ   idaṃ   taṃ   rūpaṃ   mahābhūtaṃ   santike
\glb    What   that   matter   great_element   proximate   tangible-base   this   that   matter   great_element   proximate
\ex     What is that matter which is a great element and is proximate? The tangible sense base. This is that matter which is a great element and is proximate.
```

## ^1-964

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   na   mahābhūtaṃ   dūre   Itthindriyaṃ…pe…   kabaḷīkāro   āhāro   idaṃ   taṃ   rūpaṃ   na   mahābhūtaṃ   dūre
\glb    What   that   matter   not   great_element   remote   --   nutritive_essence   nutritive_essence   this   that   matter   not   great_element   remote
\ex     What is that matter which is not a great element and is remote? The female faculty... nutritive essence. This is that matter which is not a great element and is remote.
```

## ^1-965

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   na   mahābhūtaṃ   santike   Cakkhāyatanaṃ…pe…   rasāyatanaṃ   idaṃ   taṃ   rūpaṃ   na   mahābhūtaṃ   santike
\glb    What   that   matter   not   great_element   proximate   --   taste-base   this   that   matter   not   great_element   proximate
\ex     What is that matter which is not a great element and is proximate? The eye sense base... the taste sense base. This is that matter which is not a great element and is proximate.
```
...
\glb    What   that   matter   earth_element   That   hardness   hard   state_of_hardness   nature_of_hardness   internal   or   external   or   grasped   or   not_grasped   or   this   that   matter   earth_element
\ex     What is the matter that is the earth element? That which is hardness, hard, the state of hardness, the nature of hardness, whether internal or external, grasped or not grasped – this is that matter, the earth element.
```
...
\glb    What   that   matter   water_element   That   water   watery   cohesion   cohesive   binding   of   internal   or   external   or   grasped   or   not_grasped   or   this   that   matter   water_element
\ex     What is the matter that is the water element? That which is water, watery, cohesion, cohesive, the binding of matter, whether internal or external, grasped or not grasped – this is that matter, the water element.
```
...
\glb    What   that   matter   fire_element   That   fire   fiery   heat   hot   warmth   warm   internal   or   external   or   grasped   or   not_grasped   or   this   that   matter   fire_element
\ex     What is the matter that is the fire element? That which is fire, fiery, heat, hot, warmth, warm, whether internal or external, grasped or not grasped – this is that matter, the fire element.
```
...
\glb    What   that   matter   air_element   That   air   airy   support   of   internal   or   external   or   grasped   or   not_grasped   or   this   that   matter   air_element
\ex     What is the matter that is the air element? That which is air, airy, the quality of support of matter, whether internal or external, grasped or not grasped – this is that matter, the air element.
```
...
\glb    What   that   matter   derived   --   edible   food   this   that   matter   derived   Thus   fivefold   compilation   Pentad
\ex     What is the derived matter? The eye-base… (and so on)… edible food – this is that derived matter. Thus, the compilation of matter is fivefold. The Pentad.
```
...
\glb    visual_form   cognizable_by_eye-consciousness   matter   sound   cognizable_by_ear-consciousness   matter   odour   cognizable_by_nose-consciousness   matter   taste   cognizable_by_tongue-consciousness   matter   tangible   cognizable_by_body-consciousness   matter   all   matter   mind-consciousness   matter   Thus   sixfold   compendium   Sixfold
...
\glb    visual_form   cognizable_by_eye-consciousness   matter   sound   cognizable_by_ear-consciousness   matter   odour   cognizable_by_nose-consciousness   matter   taste   cognizable_by_tongue-consciousness   matter   tangible   cognizable_by_body-consciousness   matter   visual_form   sound   odour   taste   tangible   cognizable_by_mind-element   matter   all   matter   cognizable_by_mind-consciousness-element   matter   Thus   sevenfold   compendium   Sevenfold
...
```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   cakkhundriyaṃ   Yaṃ   cakkhu   catunnaṃ   mahābhūtānaṃ   upādāya   pasādo…pe…   suñño   gāmo   peso   idaṃ   taṃ   rūpaṃ   cakkhundriyaṃ
\glb    What   that   matter   eye-faculty   That   eye   four   great_elements   derived   --   --   --   this   this   that   matter   eye-faculty
\ex     What is that material form which is the eye-faculty? That eye, which is sensitive matter derived from the four great elements…pe… this is that material form which is the eye-faculty.
```
...
\glb    What   that   material   --   --   --   body-faculty   --   --   --   life-faculty   That   those   material   phenomena   life   standing   maintaining   sustaining   carrying_on   maintaining   protecting   life   life-faculty   this   that   material   life-faculty
\ex     What is that material form which is the ear-faculty…pe… the nose-faculty…pe… the tongue-faculty…pe… the body-faculty…pe… the female-faculty…pe… the male-faculty…pe… the life-faculty? That which is the life, standing, maintaining, sustaining, carrying on, continuing, protecting, the life of those material phenomena, the life-faculty – this is that material form which is the life-faculty.
```

## ^1-977

```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   na   indriyaṃ   Rūpāyatanaṃ…pe…   kabaḷīkāro   āhāro   idaṃ   taṃ   rūpaṃ   na   indriyaṃ   Evaṃ   navavidhena   rūpasaṅgaho   Navakaṃ
\glb    What   that   material   not   faculty   --   edible   food   this   that   material   not   faculty   Thus   ninefold   collection   Ninefold
\ex     What is that material form which is not a faculty? Visual form…pe… edible food – this is that material form which is not a faculty. Thus, the collection of material forms is in nine ways. The Ninefold Group.
```
...
```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   sotindriyaṃ…pe…   ghānindriyaṃ…pe…   jivhindriyaṃ…pe…   kāyindriyaṃ…pe…   itthindriyaṃ…pe…   purisindriyaṃ…pe…   jīvitindriyaṃ   Yo   tesaṃ   rūpīnaṃ   dhammānaṃ   āyu   ṭhiti   yapanā   yāpanā   iriyanā   vattanā   pālanā   jīvitaṃ   jīvitindriyaṃ   idaṃ   taṃ   rūpaṃ   jīvitindriyaṃ
\glb    What   that   material   --   --   --   --   --   --   life-faculty   That   those   material   phenomena   life   standing   maintaining   sustaining   carrying_on   maintaining   protecting   life   life-faculty   this   that   material   life-faculty
\ex     What is that material form which is the ear-faculty…pe… the nose-faculty…pe… the tongue-faculty…pe… the body-faculty…pe… the female-faculty…pe… the male-faculty…pe… the life-faculty? That which is the life, standing, maintaining, sustaining, carrying on, continuing, protecting, the life of those material phenomena, the life-faculty – this is that material form which is the life-faculty.
```
...
\glb    What   that   material   not   faculty   impingement   --   tangible_object   this   that   material   not   faculty   impingement
...
\glb    What   that   material   not   faculty   impingement   --   nutritive_essence   nutritive_essence   this   that   material   not   faculty   impingement   Thus   tenfold   collection   Decad
\ex     What is that material phenomenon which is not a faculty and does not have impingement? Bodily intimation... up to... nutritive essence – this is that material phenomenon which is not a faculty and does not have impingement. Thus, the collection of material phenomena is tenfold. The Decad.
```
...
```gloss
\gla    Katamaṃ   taṃ   rūpaṃ   cakkhāyatanaṃ   Yaṃ   cakkhu   catunnaṃ   mahābhūtānaṃ   upādāya   pasādo…pe…   suñño   gāmo   peso   idaṃ   taṃ   rūpaṃ   cakkhāyatanaṃ
\glb    What   that   material   eye-base   That   eye   four   great_primaries   --   --   --   village   this   this   that   material   eye-base
\ex     What is that material phenomenon which is the eye-base? That eye which is a sensitive part dependent on the four great primaries... up to... a deserted village – this is that material phenomenon which is the eye-base.
```
...
\glb    What   that   matter   non-manifesting   without_impingement   included   --   nutritive_essence   nutritive_essence   this   that   matter   non-manifesting   without_impingement   included   Thus   elevenfold   collection   Elevenfold   Eighth_Recitation_Section   Classification_of_Matter   Section_on_Matter   concluded
\ex     What is that material phenomenon which is non-manifesting, without impingement, and included in the dhamma-base? Femininity faculty... up to... nutritive essence – this is that material phenomenon which is non-manifesting, without impingement, and included in the dhamma-base. Thus, the collection of material phenomena is elevenfold. The Undecad. Eighth Recitation Section. Classification of Matter. The Section on Matter is concluded.
```
