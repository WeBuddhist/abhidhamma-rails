...
source_description: Tipitaka.org Atthakatha/Tika edition export. Extracted from the combined Pañcapakaraṇa-mūlaṭīkā (abh03t.json, 1487 segments total covering all five Pañcapakaraṇa books); this file covers only source chapter 4 (Paṭṭhānapakaraṇa-mūlaṭīkā section). No alignment-based cross-links wired in this pass (deferred).
