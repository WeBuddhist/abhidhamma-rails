...
# Audience Profile — Daily Tipiṭaka

Sits alongside `requirements.md`: requirements say *how* the daily sessions are shaped; this file says *who they are for*. The session-generation skills load both before producing a day.

This profile covers the Daily Tipiṭaka as a whole — the multi-language journey toward the ITCC Bodhgayā 2026 gathering. Per-language nuance (e.g. Bengali vs. Sinhala readers) lives in each language track's own `audience.md` under `3-TRANSFORMATIONS/Translation/`.
