...
- If a term you need is not yet listed, add the row — but only after consulting the relevant glossary in `2-RAILS/Glossaries/glossary-pi-<lang>.md` and the relevant local-wiki sense page in `2-RAILS/Local-Wiki/`.
- A row is locked once it is `status: complete`. Changing a locked row means rewriting every day that uses it.

## Term table

| Pāli | English (Contemporary) | Tibetan | Chinese | Hindi | Glossary / Sense | Status |
|---|---|---|---|---|---|---|
...
(Extend this table as new terms appear. Keep entries alphabetical by Pāli.)
