...
| khandha | _heap_ (aggregate); the five: rūpa, vedanā, saññā, saṅkhāra, viññāṇa | day-078 §1, §5 | Day-078 §5 headword. First term of Book II. Commentary rāsi/koṭṭhāsa image, great-mass-of-water simile (`vibhanga-atthakatha #^2-5`). Reviewer to confirm "heap" vs conventional "aggregate". | candidate |
| rūpa (khandha) | _body_ (the body-heap; matter); ruppana = to be altered by heat/cold | day-078 §1 | Vibhaṅga usage. §1 renders rūpakkhandha "body-heap" for casual register; Book I locked *rūpa* = matter still applies in technical contexts. Reviewer to confirm. | candidate |
| saññā | _perception_ (recognising, labelling) | day-078 §1; day-079 §1 | Commentary: born of contact at the six doors (`vibhanga-atthakatha #^2-59`). | candidate |
| saṅkhāra (khandha) | _volition_ (the volition-heap, named by cetanā) | day-079 §1 | Commentary names the heap by *cetanā* as padhāna (`vibhanga-atthakatha #^2-64`). Distinct from *saṅkhata* (day-072). | candidate |
| cetanā | _intention_ (the leading factor of the volition-heap; = kamma) | day-079 §1, §5 | Day-079 §5 headword. Commentary: padhāna āyūhanaṭṭhena pākaṭattā (`vibhanga-atthakatha #^2-64`). | candidate |
