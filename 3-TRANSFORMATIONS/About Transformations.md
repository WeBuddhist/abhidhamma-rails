...
See [`Adaptations/About Adaptations.md`](Adaptations/About Adaptations.md) for the convention. (No adaptation tracks exist yet — the folder is reserved for the next round.)
...
- **`requirements.md`** — purpose, audience, the per-session shape (e.g. the seven-step daily structure in Daily-Abhidhamma), the calendar policy, the languages published, the status rules.
- **`termbase.md`** *(optional)* — standard renderings used across all sessions/languages.

See [`Plans/About Plans.md`](Plans/About Plans.md) for the convention. The currently active plan is [`Plans/Daily-Abhidhamma/`](Plans/Daily-Abhidhamma/), the 200-day reading-and-chanting journey prepared with the International Tipiṭaka Chanting Council for Bodhgayā, December 2026.
...
context_packages:
 ...
 - 2-RAILS/Local-Wiki/kusala_(wholesome).md
