...
- **`About <plan-name>.md`** (at plan root) — the cross-language brief: purpose, audience summary, per-session shape that all language streams share, list of published languages, source-rail dependencies, and status rules. Written in English.
