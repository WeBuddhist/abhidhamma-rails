...
- **`en-Contemporary-English-Abhidhamma/`** — English, modelled on the NIV translation philosophy: optimal equivalence + reader-accessible English + committee review. Requirements in English. Covers Book I (`en-dhammasangani-ai.md`) and Book II so far (`en-vibhanga-ai.md`, Khandhavibhaṅga only).
...
Add additional tracks alongside these as they are commissioned (e.g. `bo-Classical-Tibetan-Abhidhamma/`, `zh-Modern-Mandarin-Abhidhamma/`). Each track's `requirements.md` is written **in its own target language** — the working language for that track's drafters and reviewers.
