---
track: si-Contemporary-Sinhala-Abhidhamma
target_language: si
status: scaffold
last_updated: 2026-05-17
---

# Audience Profile — si-Contemporary-Sinhala-Abhidhamma

Sits alongside `requirements.md` and `termbase.md`: requirements say *how* we write; termbase says *which words*; this file says *who we write for*. The translation skill loads all three before producing a batch.

Template: `4-SYSTEM/Templates/audience.md`. Translate headings and prompts into Sinhala when filling in.
